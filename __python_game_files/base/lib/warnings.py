...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\warnings.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 20295 bytes
import sys
__all__ = [
...
def _formatwarnmsg(msg):
    try:
        ...
        if fw is not _formatwarning_orig:
            return fw((msg.message), (msg.category), (msg.filename),
              (msg.lineno), line=(msg.line))
...
def warn_explicit(message, category, filename, lineno, module=None, registry=None, module_globals=None, source=None):
    ...
    for item in filters:
        ...
        if msg is None or msg.match(text):
            if not issubclass(category, cat) or mod is None or mod.match(module):
