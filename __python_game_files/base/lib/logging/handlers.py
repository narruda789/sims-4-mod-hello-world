...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\logging\handlers.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 59128 bytes
...
class BaseRotatingHandler(logging.FileHandler):
    ...
    def rotate(self, source, dest):
        if (callable(self.rotator) or os.path.exists)(source):
