...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\email\generator.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 20483 bytes
__all__ = [
    ...
    def _handle_multipart(self, msg):
        ...
        if subparts is None:
            ...
            if isinstance(subparts, str):
                ...
                alltext = boundary or self._encoded_NL.join(msgtexts)
