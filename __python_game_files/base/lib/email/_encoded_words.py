...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\email\_encoded_words.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 8141 bytes
...
def decode_b(encoded):
    ...
    try:
        return (
         base64.b64decode(padded_encoded, validate=True), defects)
        ...
        for i in (0, 1, 2, 3):
            try:
                return (
                 base64.b64decode((encoded + b'=' * i), validate=False), defects)
            except binascii.Error:
                if i == 0:
                    defects.append(errors.InvalidBase64PaddingDefect())
