...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\binhex.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 14433 bytes
...
class _Hqxdecoderengine:
    ...
    def read(self, totalwtd):
        ...
        while wtd > 0:
            ...
            assert decdata or self.eof, 'Premature EOF on binhex file'
...
class _Rledecoderengine:
    ...
    def _fill(self, wtd):
        ...
        if self.pre_buffer[-3:] == RUNCHAR + b'\x00' + RUNCHAR:
            ...
            if self.pre_buffer[-1:] == RUNCHAR:
                mark = mark - 2
            else:
                if self.pre_buffer[-2:] == RUNCHAR + b'\x00':
                    mark = mark - 2
                else:
                    if self.pre_buffer[-2:-1] == RUNCHAR:
                        pass
                    else:
                        mark = mark - 1
