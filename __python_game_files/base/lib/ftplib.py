...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\ftplib.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 36245 bytes
import sys, socket
...
class FTP:
    ...
    def abort(self):
        ...
        resp = self.getmultiline()
        if resp[:3] not in frozenset({'225', '426', '226'}):
            raise error_proto(resp)
        return resp
