...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\modulefinder.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 23668 bytes
import dis, importlib._bootstrap_external, importlib.machinery, marshal, os, sys, types, warnings
...
class ModuleFinder:
    ...
    def load_tail(self, q, tail):
        ...
        while tail:
            ...
            m or self.msgout(4, 'raise ImportError: No module named', mname)
            ...
            if sub == '*':
                if not recursive:
                    ...
                    if all:
                        ...
                        subname = hasattr(m, sub) or '%s.%s' % (m.__name__, sub)
                        submod = self.import_module(sub, subname, m)
                        assert submod, 'No module named ' + subname
    ...
    def replace_paths_in_code(self, co):
        ...
        if self.debug:
            if original_filename not in self.processed_paths:
