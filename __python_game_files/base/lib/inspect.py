...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\inspect.py
# Compiled at: 2019-05-29 23:29:05
# Size of source mod 2**32: 120245 bytes
__author__ = ('Ka-Ping Yee <ping@lfw.org>', 'Yury Selivanov <yselivanov@sprymix.com>')
import abc, dis, collections.abc, enum_lib as enum, importlib.machinery, itertools, linecache, os, re, sys, tokenize, token, types, warnings, functools, builtins
...
def isgeneratorfunction--- This code section failed: ---

 L. 176         0  LOAD_GLOBAL              bool
                2  LOAD_GLOBAL              isfunction
                4  LOAD_FAST                'object'
                6  CALL_FUNCTION_1       1  '1 positional argument'
                8  POP_JUMP_IF_TRUE     18  'to 18'
               10  LOAD_GLOBAL              ismethod
               12  LOAD_FAST                'object'
               14  CALL_FUNCTION_1       1  '1 positional argument'
               16  JUMP_IF_FALSE_OR_POP    28  'to 28'
             18_0  COME_FROM             8  '8'
...
Parse error at or near `CALL_FUNCTION_1' instruction at offset 28


def iscoroutinefunction--- This code section failed: ---

 L. 184         0  LOAD_GLOBAL              bool
                2  LOAD_GLOBAL              isfunction
                4  LOAD_FAST                'object'
                6  CALL_FUNCTION_1       1  '1 positional argument'
                8  POP_JUMP_IF_TRUE     18  'to 18'
...
def isasyncgenfunction--- This code section failed: ---

 L. 193         0  LOAD_GLOBAL              bool
                2  LOAD_GLOBAL              isfunction
                4  LOAD_FAST                'object'
                6  CALL_FUNCTION_1       1  '1 positional argument'
                8  POP_JUMP_IF_TRUE     18  'to 18'
...
def isabstract(object):
    if not isinstance(object, type):
        ...
        if object.__flags__ & TPFLAGS_IS_ABSTRACT:
            return True
        return issubclass(type(object), abc.ABCMeta) or False
    ...
    for name in names:
        ...
        if homecls is None:
            ...
            if isinstance(dict_obj, (staticmethod, types.BuiltinMethodType)):
                ...
                if isinstance(dict_obj, (classmethod, types.ClassMethodDescriptorType)):
                    kind = 'class method'
                    obj = dict_obj
                else:
...
def getdoc(object):
    try:
        ...
        if doc is None:
            ...
            return isinstance(doc, str) or None
        return cleandoc(doc)
...
def getsourcefile(object):
    ...
    if any((filename.endswith(s) for s in all_bytecode_suffixes)):
        ...
        if any((filename.endswith(s) for s in importlib.machinery.EXTENSION_SUFFIXES)):
            return
...
def _getfullargs(co):
    ...
    return (
     args, varargs, kwonlyargs, varkw)


ArgSpec = namedtuple('ArgSpec', 'args varargs keywords defaults')

def getargspec(func):
    warnings.warn('inspect.getargspec() is deprecated, use inspect.signature() or inspect.getfullargspec()', DeprecationWarning,
      stacklevel=2)
...
def _signature_is_functionlike--- This code section failed: ---

 L.1836         0  LOAD_GLOBAL              callable
                2  LOAD_FAST                'obj'
                4  CALL_FUNCTION_1       1  '1 positional argument'
                6  POP_JUMP_IF_FALSE    16  'to 16'
                8  LOAD_GLOBAL              isclass
               10  LOAD_FAST                'obj'
               12  CALL_FUNCTION_1       1  '1 positional argument'
               14  POP_JUMP_IF_FALSE    20  'to 20'
             16_0  COME_FROM             6  '6'

 L.1839        16  LOAD_CONST               False
               18  RETURN_VALUE     
             20_0  COME_FROM            14  '14'

 L.1841        20  LOAD_GLOBAL              getattr
               22  LOAD_FAST                'obj'
               24  LOAD_STR                 '__name__'
               26  LOAD_CONST               None
               28  CALL_FUNCTION_3       3  '3 positional arguments'
               30  STORE_FAST               'name'

 L.1842        32  LOAD_GLOBAL              getattr
               34  LOAD_FAST                'obj'
               36  LOAD_STR                 '__code__'
               38  LOAD_CONST               None
               40  CALL_FUNCTION_3       3  '3 positional arguments'
               42  STORE_FAST               'code'

 L.1843        44  LOAD_GLOBAL              getattr
               46  LOAD_FAST                'obj'
               48  LOAD_STR                 '__defaults__'
               50  LOAD_GLOBAL              _void
               52  CALL_FUNCTION_3       3  '3 positional arguments'
               54  STORE_FAST               'defaults'

 L.1844        56  LOAD_GLOBAL              getattr
               58  LOAD_FAST                'obj'
               60  LOAD_STR                 '__kwdefaults__'
               62  LOAD_GLOBAL              _void
               64  CALL_FUNCTION_3       3  '3 positional arguments'
               66  STORE_FAST               'kwdefaults'

 L.1845        68  LOAD_GLOBAL              getattr
               70  LOAD_FAST                'obj'
               72  LOAD_STR                 '__annotations__'
               74  LOAD_CONST               None
               76  CALL_FUNCTION_3       3  '3 positional arguments'
               78  STORE_FAST               'annotations'

 L.1847        80  LOAD_GLOBAL              isinstance
               82  LOAD_FAST                'code'
               84  LOAD_GLOBAL              types
               86  LOAD_ATTR                CodeType
               88  CALL_FUNCTION_2       2  '2 positional arguments'
               90  JUMP_IF_FALSE_OR_POP   146  'to 146'

 L.1848        92  LOAD_GLOBAL              isinstance
               94  LOAD_FAST                'name'
               96  LOAD_GLOBAL              str
               98  CALL_FUNCTION_2       2  '2 positional arguments'
              100  JUMP_IF_FALSE_OR_POP   146  'to 146'

 L.1849       102  LOAD_FAST                'defaults'
              104  LOAD_CONST               None
              106  COMPARE_OP               is
              108  POP_JUMP_IF_TRUE    120  'to 120'
              110  LOAD_GLOBAL              isinstance
              112  LOAD_FAST                'defaults'
              114  LOAD_GLOBAL              tuple
              116  CALL_FUNCTION_2       2  '2 positional arguments'
              118  JUMP_IF_FALSE_OR_POP   146  'to 146'
            120_0  COME_FROM           108  '108'

 L.1850       120  LOAD_FAST                'kwdefaults'
              122  LOAD_CONST               None
              124  COMPARE_OP               is
              126  POP_JUMP_IF_TRUE    138  'to 138'
              128  LOAD_GLOBAL              isinstance
              130  LOAD_FAST                'kwdefaults'
 ...
 L.1851       138  LOAD_GLOBAL              isinstance
...
Parse error at or near `COME_FROM' instruction at offset 146_2
...
def _signature_fromstr(cls, obj, s, skip_bound_arg=True):
    ...
    if not isinstance(module, ast.Module):
        ...
        def p(name_node, default_node, default=empty):
            ...
            if name is invalid:
                return
            elif default_node and default_node is not _empty:
                try:
...
class Parameter:
    ...
    def __eq__(self, other):
        if self is other:
            ...
            return isinstance(other, Parameter) or NotImplemented
...
class BoundArguments:
    ...
    def __eq__(self, other):
        if self is other:
            ...
            return isinstance(other, BoundArguments) or NotImplemented
...
class Signature:
                ...
                for idx, param in enumerate(parameters):
                    ...
                    if kind < top_kind:
                        ...
                        if kind > top_kind:
                            kind_defaults = False
                            top_kind = kind
                        elif kind in (_POSITIONAL_ONLY, _POSITIONAL_OR_KEYWORD):
    ...
    def from_function(cls, func):
        warnings.warn('inspect.Signature.from_function() is deprecated, use Signature.from_callable()', DeprecationWarning,
          stacklevel=2)
        return _signature_from_function(cls, func)

    @classmethod
    def from_builtin(cls, func):
        warnings.warn('inspect.Signature.from_builtin() is deprecated, use Signature.from_callable()', DeprecationWarning,
          stacklevel=2)
    ...
    def __eq__(self, other):
        if self is other:
            ...
            return isinstance(other, Signature) or NotImplemented
