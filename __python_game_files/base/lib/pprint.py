...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\pprint.py
...
def pformat(object, indent=1, width=80, depth=None, *, compact=False):
    return PrettyPrinter(indent=indent, width=width, depth=depth, compact=compact).pformat(object)
