...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\zipfile.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 81868 bytes
...
class _ZipWriteFile(io.BufferedIOBase):
    ...
    def close(self):
        ...
        if self._zinfo.flag_bits & 8:
            ...
            self._fileobj.write(struct.pack(fmt, self._zinfo.CRC, self._zinfo.compress_size, self._zinfo.file_size))
        ...
        if mode not in frozenset({'w', 'r'}):
            ...
            if pwd:
                ...
                if mode == 'w':
                    ...
                    assert self.fp, 'Attempt to use ZIP archive that was already closed'
