...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\xml\sax\saxutils.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 12573 bytes
...
def prepare_input_source(source, base=''):
    if isinstance(source, str):
        ...
        elif source.getCharacterStream() is None and source.getByteStream() is None:
