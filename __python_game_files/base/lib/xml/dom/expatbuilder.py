...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\xml\dom\expatbuilder.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 36721 bytes
...
def _parse_ns_name(builder, name):
    ...
    return (
     intern(uri, uri), localname, prefix, qname)
...
class ExpatBuilder:
    ...
    def start_doctype_decl_handler(self, doctypeName, systemId, publicId, has_internal_subset):
        ...
        if self._filter:
            if self._filter.acceptNode(doctype) == FILTER_REJECT:
