...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\cgitb.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 12337 bytes
...
def html(einfo, context=5):
    ...
    exception = [
     '<p>%s: %s' % (strong(pydoc.html.escape(str(etype))),
