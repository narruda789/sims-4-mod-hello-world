...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\gzip.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 20912 bytes
import struct, sys, time, os, zlib, builtins, io, _compression
__all__ = [
 'GzipFile', 'open', 'compress', 'decompress']
    ...
    def __init__(self, filename=None, mode=None, compresslevel=9, fileobj=None, mtime=None):
        if mode and not 't' in mode:
            ...
            if 'b' not in mode:
                ...
                filename = isinstance(filename, (str, bytes)) or ''
            else:
