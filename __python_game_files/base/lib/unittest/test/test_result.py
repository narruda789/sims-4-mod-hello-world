...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\unittest\test\test_result.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 25704 bytes
...
class Test_TestResult(unittest.TestCase):
    ...
    def testGetSubTestDescriptionWithoutDocstring(self):
        with self.subTest(foo=1, bar=2):
            result = unittest.TextTestResult(None, True, 1)
            self.assertEqual(result.getDescription(self._subtest), 'testGetSubTestDescriptionWithoutDocstring (' + __name__ + '.Test_TestResult) (foo=1, bar=2)')
        with self.subTest('some message'):
            result = unittest.TextTestResult(None, True, 1)
            self.assertEqual(result.getDescription(self._subtest), 'testGetSubTestDescriptionWithoutDocstring (' + __name__ + '.Test_TestResult) [some message]')

    def testGetSubTestDescriptionWithoutDocstringAndParams(self):
        with self.subTest():
            result = unittest.TextTestResult(None, True, 1)
            self.assertEqual(result.getDescription(self._subtest), 'testGetSubTestDescriptionWithoutDocstringAndParams (' + __name__ + '.Test_TestResult) (<subtest>)')
    ...
    def testGetNestedSubTestDescriptionWithoutDocstring(self):
        with self.subTest(foo=1):
            with self.subTest(baz=2, bar=3):
                result = unittest.TextTestResult(None, True, 1)
                self.assertEqual(result.getDescription(self._subtest), 'testGetNestedSubTestDescriptionWithoutDocstring (' + __name__ + '.Test_TestResult) (baz=2, bar=3, foo=1)')

    def testGetDuplicatedNestedSubTestDescriptionWithoutDocstring(self):
        with self.subTest(foo=1, bar=2):
            with self.subTest(baz=3, bar=4):
                result = unittest.TextTestResult(None, True, 1)
                self.assertEqual(result.getDescription(self._subtest), 'testGetDuplicatedNestedSubTestDescriptionWithoutDocstring (' + __name__ + '.Test_TestResult) (baz=3, bar=4, foo=1)')
    ...
    def testGetSubTestDescriptionWithOneLineDocstring(self):
        result = unittest.TextTestResult(None, True, 1)
        with self.subTest(foo=1, bar=2):
            self.assertEqual(result.getDescription(self._subtest), 'testGetSubTestDescriptionWithOneLineDocstring (' + __name__ + '.Test_TestResult) (foo=1, bar=2)\nTests getDescription() for a method with a docstring.')
    ...
    def testGetSubTestDescriptionWithMultiLineDocstring(self):
        result = unittest.TextTestResult(None, True, 1)
        with self.subTest(foo=1, bar=2):
            self.assertEqual(result.getDescription(self._subtest), 'testGetSubTestDescriptionWithMultiLineDocstring (' + __name__ + '.Test_TestResult) (foo=1, bar=2)\nTests getDescription() for a method with a longer docstring.')
...
class Test_OldTestResult(unittest.TestCase):
    ...
    def testOldTestResult(self):
        ...
        for test_name, should_pass in (('testSkip', True), ('testExpectedFail', True),
