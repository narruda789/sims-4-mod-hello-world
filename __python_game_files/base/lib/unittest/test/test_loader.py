...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\unittest\test\test_loader.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 64266 bytes
import sys, types, warnings, unittest
        ...
        with warnings.catch_warnings():
            ...
            with self.assertRaises(TypeError) as (cm):
                loader.loadTestsFromModule(m,
                  use_load_tests=False, very_bad=True, worse=False)
        self.assertEqual(type(cm.exception), TypeError)
