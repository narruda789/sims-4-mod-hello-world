...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\unittest\test\testmock\testmock.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 52053 bytes
import copy, sys, tempfile, unittest
from unittest.test.testmock.support import is_instance
from unittest import mock
from unittest.mock import call, DEFAULT, patch, sentinel, MagicMock, Mock, NonCallableMock, NonCallableMagicMock, _CallList, create_autospec
...
class MockTest(unittest.TestCase):
    ...
    def test_reset_mock(self):
        ...
        self.assertEqual(mock.method_calls, [], 'method_calls not initialised correctly: %r != %r' % (
         mock.method_calls, []))
    ...
    def test_call(self):
        ...
        self.assertEqual(mock.call_args, (
         (
          sentinel.Arg,), {'key': sentinel.KeyArg}), 'call_args not set')
        self.assertEqual(mock.call_args_list, [
         ...
         (
          (
           sentinel.Arg,), {'key': sentinel.KeyArg})], 'call_args_list not set')
    ...
    def test_assert_called_once_with_function_spec(self):
        ...
        self.assertRaises(AssertionError, (mock.assert_called_once_with), 1,
          b=3, c=2)
        with self.assertRaises(AssertionError) as (cm):
    ...
    def test_method_calls_recorded(self):
        ...
        self.assertEqual(mock.method_calls, [
         ...
         (
          'something_else.something', (6, ), {'cake': sentinel.Cake})], 'method calls not recorded correctly')
    ...
    def test_configure_mock(self):
        ...
        self.assertEqual(mock.foo, 'bar')
        kwargs = {'side_effect':KeyError, 
         'foo.bar.return_value':33,  'foo':MagicMock()}
        mock = Mock(**kwargs)
    ...
    def test_assert_called_with_failure_message(self):
        ...
        self.assertRaisesWithMsg(AssertionError,
          (message % (expected,)), (mock.assert_called_with),
          1, '2', 3, bar='foo')
    ...
    def test_assert_has_calls_any_order(self):
        ...
        for kall_list in kall_lists:
            self.assertRaises(AssertionError,
              (mock.assert_has_calls), kall_list,
              any_order=True)
    ...
    def test_assert_any_call_with_function_spec(self):
        ...
        self.assertRaises(AssertionError, (mock.assert_any_call), 1,
          b=3, c=2)
        with self.assertRaises(AssertionError) as (cm):
