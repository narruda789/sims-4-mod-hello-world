...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\unittest\test\test_discovery.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 34566 bytes
import os.path
from os.path import abspath
import re, sys, types, pickle
from test import support
import test.test_importlib.util, unittest, unittest.mock, unittest.test
...
class TestDiscovery(unittest.TestCase):
    ...
    def test_find_tests(self):
        ...
        expected.extend([['test_dir.%s' % name + ' module tests'] for name in ('test3',
                                                                               'test4')])
            ...
            def __init__(self, path):
                ...
                if path.endswith('test_module'):
                    ...
                    def load_tests(loader, tests, pattern):
                        ...
                        pkg_tests = loader.discover(start_dir=this_dir,
                          pattern=pattern)
    ...
    def test_detect_module_clash(self):
        ...
        msg = re.escape("'foo' module incorrectly imported from %r. Expected %r. Is this module globally installed?" % (
         mod_dir, expected_dir))
        self.assertRaisesRegex(ImportError,
          ('^%s$' % msg), (loader.discover), start_dir='foo',
          pattern='foo.py')
    ...
    def test_discovery_from_dotted_namespace_packages(self):
        ...
        package.__spec__ = types.SimpleNamespace(loader=None,
