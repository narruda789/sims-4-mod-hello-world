...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\unittest\result.py
...
class TestResult(object):
    ...
    def _exc_info_to_string(self, err, test):
        ...
        tb_e = traceback.TracebackException(exctype,
          value, tb, limit=length, capture_locals=(self.tb_locals))
    ...
    def _count_relevant_tb_levels(self, tb):
        length = 0
        while tb:
            self._is_relevant_tb_level(tb) or length += 1
            tb = tb.tb_next
