...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\shutil.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 42185 bytes
    ...
    try:
        for info in zip.infolist():
            ...
            if not name.startswith('/'):
                ...
                data = name.endswith('/') or zip.read(info.filename)
                f = open(target, 'wb')
                try:
                    f.write(data)
                finally:
