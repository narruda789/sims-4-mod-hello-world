...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\_compression.py
            ...
            while 1:
                if self._decompressor.eof:
                    ...
                    if self._decompressor.needs_input:
                        ...
                        assert rawblock, 'Compressed file ended before the end-of-stream marker was reached'
                    else:
                        rawblock = b''
                    data = self._decompressor.decompress(rawblock, size)
                if data:
