...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\os.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 38834 bytes
...
def walk(top, topdown=True, onerror=None, followlinks=False):
    ...
    if topdown:
        ...
        for dirname in dirs:
            ...
            if not followlinks:
                yield from islink(new_path) or walk(new_path, topdown, onerror, followlinks)
