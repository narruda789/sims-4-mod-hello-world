...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\platform.py
# Compiled at: 2018-08-07 18:33:59
# Size of source mod 2**32: 47507 bytes
    ...
    if not bits:
        ...
        if not fileout:
            if executable == sys.executable:
                ...
                return (
                 bits, linkage)
        elif 'executable' not in fileout:
            return (bits, linkage)
        ...
        if system in ('Linux', ):
            ...
            if distname:
                ...
                if system == 'Java':
                    ...
                    if not terse:
                        platform = os_name or _platform(system, release, version)
                    else:
