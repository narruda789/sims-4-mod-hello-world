...
def visiblename(name, all=None, obj=None):
    if name in frozenset({'__name__', '__cached__', '__builtins__', '__module__', '__qualname__', '__doc__', '__author__', '__loader__', '__file__', '__date__', '__path__', '__slots__', '__credits__', '__version__', '__package__', '__spec__'}):
        return 0
    else:
...
class Helper:
 ...
 '>=', '==', '!=', '<>'), 
    ...
    topics = {'TYPES':('types', 'STRINGS UNICODE NUMBERS SEQUENCES MAPPINGS FUNCTIONS CLASSES MODULES FILES inspect'),  'STRINGS':('strings', 'str UNICODE SEQUENCES STRINGMETHODS FORMATTING TYPES'), 
