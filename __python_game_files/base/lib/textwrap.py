...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\textwrap.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 19980 bytes
import re
__all__ = [
        ...
        while chunks:
            ...
            if self.drop_whitespace and cur_line:
                if cur_line[(-1)].strip() == '':
                    ...
                    del cur_line[-1]
            if cur_line and not self.max_lines is None or len(lines) + 1 < self.max_lines:
