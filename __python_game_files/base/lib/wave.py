...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\wave.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 18748 bytes
import builtins
__all__ = [
 'open', 'openfp', 'Error', 'Wave_read', 'Wave_write']
...
class Wave_read:
    ...
    def _read_fmt_chunk(self, chunk):
        ...
        if wFormatTag == WAVE_FORMAT_PCM:
            ...
            assert self._sampwidth, 'bad sample width'
        else:
    ...
    def _ensure_header_written(self, datasize):
        if not self._headerwritten:
            if not self._nchannels:
                ...
                assert self._framerate, 'sampling rate not specified'
...
def openfp(f, mode=None):
    warnings.warn('wave.openfp is deprecated since Python 3.7. Use wave.open instead.', DeprecationWarning,
      stacklevel=2)
