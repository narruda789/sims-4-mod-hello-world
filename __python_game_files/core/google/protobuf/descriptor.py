...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\google\protobuf\descriptor.py
# Compiled at: 2013-10-04 12:43:25
# Size of source mod 2**32: 27338 bytes
...
class Descriptor(_NestedDescriptorBase):
    ...
    def __init__(self, name, full_name, filename, containing_type, fields, nested_types, enum_types, extensions, options=None, is_extendable=True, extension_ranges=None, file=None, serialized_start=None, serialized_end=None):
        super(Descriptor, self).__init__(options,
          'MessageOptions', name, full_name, file, containing_type,
...
class EnumDescriptor(_NestedDescriptorBase):
    ...
    def __init__(self, name, full_name, filename, values, containing_type=None, options=None, file=None, serialized_start=None, serialized_end=None):
        super(EnumDescriptor, self).__init__(options,
          'EnumOptions', name, full_name, file, containing_type,
          serialized_start=serialized_start, serialized_end=serialized_start)
        self.values = values
...
class ServiceDescriptor(_NestedDescriptorBase):
    ...
    def __init__(self, name, full_name, index, methods, options=None, file=None, serialized_start=None, serialized_end=None):
        super(ServiceDescriptor, self).__init__(options,
          'ServiceOptions', name, full_name, file, None,
          serialized_start=serialized_start, serialized_end=serialized_end)
        self.index = index
...
def MakeDescriptor(desc_proto, package=''):
    ...
    for field_proto in desc_proto.field:
        ...
        field = FieldDescriptor((field_proto.name),
          full_name, (field_proto.number - 1), (field_proto.number),
          (field_proto.type), (FieldDescriptor.ProtoTypeToCppProtoType(field_proto.type)),
          (field_proto.label),
          None, None, None, None, False, None, has_default_value=False)
        fields.append(field)
