...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\google\protobuf\compiler\plugin_pb2.py
# Compiled at: 2011-01-29 03:36:16
# Size of source mod 2**32: 6557 bytes
from google.protobuf import descriptor
from google.protobuf import message
from google.protobuf import reflection
from google.protobuf import descriptor_pb2
import google.protobuf.descriptor_pb2
DESCRIPTOR = descriptor.FileDescriptor(name='google/protobuf/compiler/plugin.proto',
...
_CODEGENERATORREQUEST = descriptor.Descriptor(name='CodeGeneratorRequest',
  full_name='google.protobuf.compiler.CodeGeneratorRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='file_to_generate',
   ...
   options=None),
 descriptor.FieldDescriptor(name='parameter',
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='proto_file',
...
_CODEGENERATORRESPONSE_FILE = descriptor.Descriptor(name='File',
 ...
 descriptor.FieldDescriptor(name='name',
   full_name='google.protobuf.compiler.CodeGeneratorResponse.File.name',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='insertion_point',
   full_name='google.protobuf.compiler.CodeGeneratorResponse.File.insertion_point',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='content',
   full_name='google.protobuf.compiler.CodeGeneratorResponse.File.content',
   index=2,
   number=15,
   type=9,
   cpp_type=9,
  ...
  serialized_end=399)
_CODEGENERATORRESPONSE = descriptor.Descriptor(name='CodeGeneratorResponse',
