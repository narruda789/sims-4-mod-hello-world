...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\google\protobuf\internal\type_checkers.py
# Compiled at: 2011-01-29 03:11:03
...
def GetTypeChecker(cpp_type, field_type):
    if cpp_type == _FieldDescriptor.CPPTYPE_STRING:
        if field_type == _FieldDescriptor.TYPE_STRING:
...
_VALUE_CHECKERS = {_FieldDescriptor.CPPTYPE_INT32: Int32ValueChecker(), 
 ...
 _FieldDescriptor.CPPTYPE_DOUBLE: TypeChecker(float, int, int), 
 
 _FieldDescriptor.CPPTYPE_FLOAT: TypeChecker(float, int, int), 
