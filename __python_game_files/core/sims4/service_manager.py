...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\sims4\service_manager.py
# Compiled at: 2020-06-08 16:31:54
# Size of source mod 2**32: 24540 bytes
import re
from sims4.common import is_available_pack, Pack
from sims4.utils import classproperty
import persistence_error_types, sims4.log, sims4.perf_log, sims4.profiler_utils, sims4.reload
...
class ServiceManager:
    ...
    def start_single_service(self):
        if not self._services_to_start:
            ...
            return self._services_to_start or True
        return False
    ...
    def _perf_log(self, context, message, service, fn_name):
        ...
        if _gsi_reporter is not None:
            if _gsi_reporter.enabled:
