...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\sims4\gsi\schema.py
# Compiled at: 2017-04-21 14:06:28
...
class GsiSchema:
    ...
    def add_has_many(self, name, schema_class, *args, **kwargs):
        ...
        self.output['associations'].append({'name':name,  'type':'hasMany', 
         'schema':new_schema.output})
        return new_schema
    ...
    def add_has_one(self, name, schema_class, *args, **kwargs):
        ...
        if self.associations is None:
            self.associations = []
            self.output['associations'] = self.associations
        self.output['associations'].append({'name':name,  'type':'hasOne', 
         'schema':new_schema.output})
        return new_schema
