...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\sims4\localization\__init__.py
# Compiled at: 2020-04-20 19:21:00
# Size of source mod 2**32: 23683 bytes
...
class TunableLocalizedStringFactoryVariant(TunableVariant):
    ...
    def __init__(self, description='A localization string. This may either be a single string, a set to pick a random string from, or concatenation from list of string.', allow_none=False, **kwargs):
        (super().__init__)(single=TunableLocalizedStringFactory(allow_none=allow_none) if self.is_factory else TunableLocalizedString(allow_none=allow_none), 
         variation=self.TunableLocalizedStringFactoryVariation(allow_none=allow_none) if self.is_factory else self.TunableLocalizedStringVariation(allow_none=allow_none), 
         concatenation=self.TunableLocalizedStringFactoryConcatenation(allow_none=allow_none) if self.is_factory else self.TunableLocalizedStringConcatenation(allow_none=allow_none), 
         default='single', 
