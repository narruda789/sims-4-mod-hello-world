...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\object_routing\set_routing_info_and_state_op.py
# Compiled at: 2020-06-10 19:20:21
...
class SetRoutingInfoAndStateOp(BaseLootOperation):
    ...
    def _apply_to_subject_and_target(self, subject, target, resolver):
        if subject is None:
            logger.error('Attempting to set routing info and state to a none object. participant {}. Loot: {}', (self.subject),
              self, owner='yozhang')
            return
