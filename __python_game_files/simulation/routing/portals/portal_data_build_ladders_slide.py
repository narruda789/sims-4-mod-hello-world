...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\portals\portal_data_build_ladders_slide.py
# Compiled at: 2020-03-27 17:05:31
...
class _PortalTypeDataBuildLaddersSlide(_PortalTypeDataBase, _BuildLaddersMixin, _VariableJumpMixin):
    ...
    def _get_arb(self, actor, portal_instance, *, is_mirrored):
        ...
        if is_mirrored:
            entry_location, exit_location = slide_end_location, portal_instance.back_exit
        else:
            entry_location, exit_location = portal_instance.there_entry, slide_end_location
