...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\portals\portal_data_ladders.py
# Compiled at: 2020-02-11 15:59:13
# Size of source mod 2**32: 6286 bytes
...
class _PortalTypeDataLadders(_PortalTypeDataBase):
    FACTORY_TUNABLES = {'ladder_rung_distance':Tunable(description='\n            The distance between rungs on the ladder object.\n            ',
       tunable_type=float,
       default=0.25), 
     'ladder_up_start_cycle':Tunable(description='\n            The name of the animation clip for the up start cycle.\n            ',
       tunable_type=str,
       default='ladder_up_start',
       tuning_group=GroupNames.ANIMATION), 
     'ladder_up_climb_cycle':Tunable(description='\n            The name of the animation clip for the up climb cycle.\n            ',
       tunable_type=str,
       default='ladder_up_cycle_r',
       tuning_group=GroupNames.ANIMATION), 
     'ladder_up_stop_cycle':Tunable(description='\n            The name of the animation clip for the up stop cycle.\n            ',
       tunable_type=str,
       default='ladder_up_stop',
       tuning_group=GroupNames.ANIMATION), 
     'ladder_down_start_cycle':Tunable(description='\n            The name of the animation clip for the down start cycle.\n            ',
       tunable_type=str,
       default='ladder_down_start',
       tuning_group=GroupNames.ANIMATION), 
     'ladder_down_climb_cycle':Tunable(description='\n            The name of the animation clip for the down climb cycle.\n            ',
       tunable_type=str,
       default='ladder_down_cycle_r',
       tuning_group=GroupNames.ANIMATION), 
     'ladder_down_stop_cycle':Tunable(description='\n            The name of the animation clip for the down stop cycle.\n            ',
       tunable_type=str,
       default='ladder_down_stop',
       tuning_group=GroupNames.ANIMATION), 
     'walkstyle_duration':Tunable(description='\n            The name of the duration field in the animation data.\n            ',
       tunable_type=str,
       default='duration',
       tuning_group=GroupNames.ANIMATION)}
