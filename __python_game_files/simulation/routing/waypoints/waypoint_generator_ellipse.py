...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\waypoints\waypoint_generator_ellipse.py
# Compiled at: 2020-05-21 18:51:23
...
class _WaypointGeneratorEllipse(_WaypointGeneratorBase):
    ...
    def get_start_angle(self):
        ...
        if sims4.math.vector3_almost_equal(sim_vec, sims4.math.Vector3.ZERO()):
            return sims4.math.yaw_quaternion_to_angle(self._context.sim.transform.orientation)
    ...
    def get_ellipse_point_constraint(self, theta):
        ...
        return SmallAreaConstraint(geometry=geometry, debug_name='EllipsePoint',
