...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\route_events\route_event_paired.py
# Compiled at: 2020-10-06 16:03:14
# Size of source mod 2**32: 5186 bytes
...
import interactions.utils.sim_focus, sims4.log
...
class RouteEventPaired(RouteEvent):
    ...
    def on_executed(self, sim, path=None):
        if sim is not self.actor:
            ...
            return
        elif self.paired_event is None:
    ...
    def _start_focus(self):
        ...
        if self.focus.focus_bone_override is not None:
            ...
            if not hasattr(target_sim, 'get_focus_bone'):
...
lock_instance_tunables(RouteEventPaired, scheduling_override=None,
