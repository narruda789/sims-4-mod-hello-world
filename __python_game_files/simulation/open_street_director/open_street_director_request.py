...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\open_street_director\open_street_director_request.py
# Compiled at: 2019-08-15 18:30:30
# Size of source mod 2**32: 12443 bytes
from open_street_director.open_street_director import OpenStreetDirectorPriority
import alarms, enum, services, sims4.log
...
class OpenStreetDirectorRequest:
    ...
    def cleanup(self):
        if self._open_street_director is not None:
            if self._state == OpenStreetDirectorRequestState.SHUTDOWN or self._state == OpenStreetDirectorRequestState.ACTIVE_REQUEST:
...
class OpenStreetDirectorRequestFactory(OpenStreetDirectorRequest):
    ...
    def get_request(self):
        try:
            ...
            request = OpenStreetDirectorRequest(open_street_director, preroll_start_time=(self._preroll_start_time),
