...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\open_street_director\lamp_festival.py
# Compiled at: 2016-10-20 19:42:24
# Size of source mod 2**32: 16765 bytes
...
class LampContestFestivalSituation(BaseGenericFestivalSituation):
    INSTANCE_TUNABLES = {'_contest_state':LampContestFestivalSituationState.TunableFactory(description='\n            The first state that the Sims will be put into when this Situation\n            Starts.\n            ',
     ...
     '_dark_win_rewards':TunableReference(description='\n            A reference to a loot that will be applied to winning teams.\n            ',
       manager=services.get_instance_manager(sims4.resources.Types.ACTION),
       class_restrictions=('LootActions', )), 
     '_tie_rewards':TunableReference(description='\n            A reference to a loot that will be applied to tied teams.\n            ',
       manager=services.get_instance_manager(sims4.resources.Types.ACTION),
       class_restrictions=('LootActions', ))}
    ...
    @classmethod
    def _states(cls):
        return (SituationStateData(1, LampContestFestivalSituationState, factory=(cls._contest_state)),
         SituationStateData(2, LightWinVictoryState, factory=(cls._light_win_state)),
         SituationStateData(3, DarkWinVictoryState, factory=(cls._dark_win_state)),
         SituationStateData(4, TieVictoryState, factory=(cls._tie_state)))

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (cls._contest_state._tuned_values.light_sim_job_and_default_role_state.job,
          cls._contest_state._tuned_values.light_sim_job_and_default_role_state.role_state),
         (
          cls._contest_state._tuned_values.dark_sim_job_and_default_role_state.job,
          cls._contest_state._tuned_values.dark_sim_job_and_default_role_state.role_state)]
...
lock_instance_tunables(LampContestFestivalSituation, exclusivity=(BouncerExclusivityCategory.VENUE_BACKGROUND),
