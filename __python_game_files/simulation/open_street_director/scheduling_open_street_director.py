...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\open_street_director\scheduling_open_street_director.py
# Compiled at: 2020-10-29 18:28:33
# Size of source mod 2**32: 13743 bytes
...
import alarms, date_and_time, services, sims4.log
    ...
    def _create_layer(self, conditional_layer, start_time, end_time, end_alarm_handle=None):
        if self._prerolling:
            if conditional_layer in self._loaded_layers:
                ...
                self._current_layers[conditional_layer] = (
                 start_time, end_time, end_alarm_handle)
