...
# Size of source mod 2**32: 59761 bytes
...
import algos, event_testing.test_base, services, sims4.resources, sims4.tuning.tunable, statistics.statistic
                ...
                if target_obj is None:
                    ...
                    if self.target_stats:
                        for target_stat in self.target_stats:
                            if target_stat is None:
                                return TestResult(False, 'Target stat failed to load.')
