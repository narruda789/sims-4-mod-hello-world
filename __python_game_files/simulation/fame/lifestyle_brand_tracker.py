...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\fame\lifestyle_brand_tracker.py
...
class LifestyleBrandTracker(SimInfoTracker):
    ...
    def payout_lifestyle_brand(self):
        if not self.active:
            ...
            bucks_tracker is None or bucks_tracker.is_perk_unlocked(FameTunables.LIFESTYLE_BRAND_PERK) or self.clear_brand()
            return
