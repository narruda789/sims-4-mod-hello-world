...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\tunable_utils\placement_tuning.py
# Compiled at: 2016-04-27 23:23:28
# Size of source mod 2**32: 12433 bytes
...
class TunableOrientationRangeRestriction(TunableFactory):
    ...
    def _factory(angle, ideal_angle, **kwargs):
        ...
        return AbsoluteOrientationRange(min_angle=(angle.lower_bound + base_angle), max_angle=(angle.upper_bound + base_angle),
          ideal_angle=(ideal_angle + base_angle),
          weight=1.0)
  ...
  tunable_type=TunableAngle,
  default_upper=0,
  default_lower=0), 
         ideal_angle=TunableAngle(description='\n                Ideal angle for orientation of the target.\n                ',
  default=0), 
...
class TunableOrientationRestriction(TunableVariant):
    ...
    def __init__(self, **kwargs):
        (super().__init__)(absolute_orientation=TunableOrientationRangeRestriction(), 
         relative_facing_range=TunableRelativeFacingRangeRestriction(), 
         relative_facing_circle=TunableRelativeFacingCircleRestriction(), 
         default='absolute_orientation', **kwargs)


class TunablePlacementScoringFunction(TunableVariant):

    def __init__(self, **kwargs):
        (super().__init__)(radial_distance_scoring=TunableRadialDistanceScoring(), 
         angular_scoring=TunableAngularScoring(), 
         linear_distance_scoring=TunableLinearDistanceScoring(), 
         default='radial_distance_scoring', **kwargs)