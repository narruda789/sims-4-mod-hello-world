...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\vet\vet_clinic_manager.py
# Compiled at: 2017-10-16 17:17:58
# Size of source mod 2**32: 8730 bytes
...
class VetClinicManager(HasAdvertisingManagerMixin, BusinessManager):
    ...
    def load_data(self, business_save_data, is_legacy=False):
        ...
        if profit_per_treatment_save_data:
            if len(profit_per_treatment_save_data) > VetClinicTuning.MAX_COUNT_FOR_OFF_LOT_PROFIT_PER_TREATMENT:
