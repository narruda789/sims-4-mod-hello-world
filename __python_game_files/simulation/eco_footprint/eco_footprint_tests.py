...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\eco_footprint\eco_footprint_tests.py
# Compiled at: 2020-04-22 15:02:51
...
class StreetEcoFootprintTest(StreetCivicPolicySelectorTestMixin, BaseTest):
    FACTORY_TUNABLES = {'eco_footprint_tests': TunableList(description='\n            ',
                              ...
                              default='state',
                              state=(_EcoFootprintTestState.TunableFactory()),
                              direction=(_EcoFootprintTestDirection.TunableFactory())))}
