...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\indexed_manager.py
# Compiled at: 2021-06-11 14:13:04
# Size of source mod 2**32: 13428 bytes
import _weakrefutils, time
from sims4.callback_utils import CallableList
from sims4.service_manager import Service
import enum, gsi_handlers, id_generator, services, sims4.log
...
class IndexedManager(Service):
    ...
    def is_callback_registered(self, callback_type, callback):
        callback_list = self._registered_callbacks[callback_type]
        return callback in callback_list

    def add(self, obj):
        global object_load_times
        if capture_load_times:
            ...
            if capture_load_times and hasattr(obj, 'definition'):
