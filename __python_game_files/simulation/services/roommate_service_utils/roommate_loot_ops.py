...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\services\roommate_service_utils\roommate_loot_ops.py
# Compiled at: 2019-07-24 12:59:52
...
import services, sims4.log, singletons, traits.traits
...
class RoommateLootOp(BaseLootOperation):
    ...
    FACTORY_TUNABLES = {'operation_type': TunableVariant(description='\n            The type of roommate operation to perform.\n            ',
                         add_remove_roommate=(AddRemoveRoommate.TunableFactory()),
                         ad_on_off=(AdOnOff.TunableFactory()),
                         queue_locked_out_situation=(QueueLockedOutSituation.TunableFactory()),
                         set_clear_roommate_leave_reason=(SetClearRoommateLeaveReason.TunableFactory()),
                         default='add_remove_roommate')}
