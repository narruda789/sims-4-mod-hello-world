...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\tutorials\tutorial_service.py
# Compiled at: 2018-12-04 15:46:54
...
import services, sims4.log, sims4.localization
...
class TutorialService(Service):
    ...
    TUTORIAL_DRAMA_NODE = TunableReference(description='\n        The drama node that controls the tutorial.\n        ',
      ...
      class_restrictions=('TutorialDramaNode', ))
    ...
    def is_tutorial_running(self):
        drama_scheduler = services.drama_scheduler_service()
        return drama_scheduler is None or drama_scheduler.get_running_nodes_by_drama_node_type(DramaNodeType.TUTORIAL) or False
        return True