...
# Size of source mod 2**32: 5254 bytes
...
class TunablePuddleFactory(TunableTuple):
    ...
    def __init__(self, **kwargs):
        (super().__init__)(none=TunableRange(int, 5, minimum=0, description='Relative chance of no puddle.'), 
         small=TunableRange(int, 5, minimum=0, description='Relative chance of small puddle.'), 
         medium=TunableRange(int, 0, minimum=0, description='Relative chance of medium puddle.'), 
         large=TunableRange(int, 0, minimum=0, description='Relative chance of large puddle.'), 
         liquid=TunableEnumEntry(description='\n                The liquid of the puddle that will be generated.\n                ',
  tunable_type=PuddleLiquid,
  default=(PuddleLiquid.WATER)), **kwargs)
...
class CreatePuddlesLootOp(BaseTargetedLootOperation):
    FACTORY_TUNABLES = {'description':'\n            This loot will create puddles based on a tuned set of chances.\n            ', 
     'trait_based_puddle_factory':OptionalTunable(description='\n            A particpant type may be set to choose a puddle factory\n            based on traits the participant has.\n                     \n            If disabled, the default puddle factory is used.\n            ',
       ...
       trait_puddle_factory=TunableList(description='\n                    Ordered list of puddle factories with associated trait.\n                    Will use the first factory whose trait is on the subject.\n                    ',
       tunable=TunableTuple(trait=TunableReference(manager=(services.get_instance_manager(sims4.resources.Types.TRAIT))),
       puddle_factory=TunablePuddleFactory(description='\n                            The chance of creating a puddle of various sizes.\n                            '))))), 
