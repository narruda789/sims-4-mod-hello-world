...
# Size of source mod 2**32: 120371 bytes
...
from objects.components.state import TunableStateComponent, TunableStateValueReference
...
class ScriptObject(BaseObject, HasStatisticComponent, HasFootprintComponent, metaclass=HashedTunedInstanceMetaclass, manager=services.definition_manager()):
 ...
 L. 770       118  LOAD_GLOBAL              ItemLocation
              120  LOAD_ATTR                INVALID_LOCATION
              122  LOAD_FAST                'self'
              124  STORE_ATTR               item_location

 L. 772       126  SETUP_LOOP          190  'to 190'
              128  LOAD_FAST                'self'
 ...
 L. 779       202  LOAD_GLOBAL              PersistenceGroups
              204  LOAD_ATTR                NONE
              206  LOAD_FAST                'self'
