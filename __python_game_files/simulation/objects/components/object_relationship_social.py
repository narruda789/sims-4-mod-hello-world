...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\object_relationship_social.py
# Compiled at: 2018-04-18 17:08:01
    ...
    def _do_behavior(self, *args, **kwargs):
        if self.interaction.target is None:
            ...
            if self.interaction.target.objectrelationship_component is None:
                ...
                return
            self.interaction.get_liability(ObjectRelationshipSocialLiability.LIABILITY_TOKEN) or self.interaction.add_liability(ObjectRelationshipSocialLiability.LIABILITY_TOKEN, ObjectRelationshipSocialLiability())
...
class ObjectRelationshipSocialLiability(Liability):
    ...
    def _trigger_social_start(self, sim):
        if self._objectrelationship_component:
