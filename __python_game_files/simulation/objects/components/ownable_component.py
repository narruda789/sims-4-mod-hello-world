...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\ownable_component.py
# Compiled at: 2020-04-23 19:09:08
...
class OwnableComponent(Component, HasTunableFactory, component_name=types.OWNABLE_COMPONENT, persistence_key=protocols.PersistenceMaster.PersistableData.OwnableComponent):
    DEFAULT_OWNABLE_COMPONENT_AFFORDANCES = TunableList(TunableReference(manager=(services.get_instance_manager(sims4.resources.Types.INTERACTION))),
