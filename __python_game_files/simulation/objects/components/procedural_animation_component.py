...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\procedural_animation_component.py
# Compiled at: 2021-03-22 20:38:12
# Size of source mod 2**32: 3763 bytes
from animation.animation_constants import ActorType
from animation.animation_controls import ProceduralControlWheel, ProceduralControlSphereWheel, ProceduralControlSkate, ProceduralControlLipSync
...
class ProceduralAnimationComponent(Component, HasTunableFactory, AutoFactoryInit, component_name=types.PROCEDURAL_ANIMATION_COMPONENT):
    FACTORY_TUNABLES = {'controls': TunableMapping(description='\n            List of animated controls that the client needs to animate and manage.\n            Each of them has a key so we can refer them in other places.\n            ',
                   ...
                   sphere_wheel=(ProceduralControlSphereWheel.TunableFactory()),
                   skate=(ProceduralControlSkate.TunableFactory()),
                   lip_sync=(ProceduralControlLipSync.TunableFactory())),
                   key_name='control_id',
                   value_name='control_type')}
