...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\stored_object_info_component.py
# Compiled at: 2019-05-17 20:33:41
# Size of source mod 2**32: 13552 bytes
...
class StoreObjectInfoLootOp(BaseTargetedLootOperation):
    ...
    def _apply_to_subject_and_target(self, subject, target, resolver):
        ...
        stored_object_component.add_object((self._stored_object_type), (target.id),
