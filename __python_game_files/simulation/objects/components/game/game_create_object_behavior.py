...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\game\game_create_object_behavior.py
# Compiled at: 2019-09-30 18:57:14
    ...
    def on_setup_game(self, game_object):
        for target_object, parent_slot in self.objects.items():
            ...
            for runtime_slot in game_object.get_runtime_slots_gen(slot_types=slot_types, bone_name_hash=bone_name_hash):
                ...
                if not valid_object_in_slot:
                    if runtime_slot.is_valid_for_placement(definition=target_object, objects_to_ignore=child_objects):
