...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\hovertip.py
# Compiled at: 2020-03-26 20:55:07
...
class TunableHovertipTuple(TunableTuple):
    ...
    def __init__(self, **kwargs):
        super().__init__(hovertip_style=TunableEnumEntry(description='\n                Style of the hovertip that will apply this restriction.\n                ',
          ...
          skill=TunableReference(manager=(services.get_instance_manager(sims4.resources.Types.STATISTIC)),
