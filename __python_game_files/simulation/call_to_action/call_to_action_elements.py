...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\call_to_action\call_to_action_elements.py
# Compiled at: 2016-06-20 18:12:33
...
class TurnOffCallToAction(XevtTriggeredElement):
    ...
    def _do_behavior(self):
        ...
        if participant is not None:
            if participant.sim_info.is_selectable:
