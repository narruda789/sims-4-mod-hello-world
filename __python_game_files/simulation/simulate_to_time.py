...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\simulate_to_time.py
# Compiled at: 2018-07-11 15:31:25
        ...
        if self._alarm_handle != None:
            ...
            if target_hours is None:
                if target_minutes is None:
                    if days_ahead is None and target_speed is None:
                        if canceled:
