...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\holidays\lottery_holiday.py
# Compiled at: 2020-02-07 16:50:40
# Size of source mod 2**32: 8968 bytes
import random
...
class LotteryDramaNode(BaseDramaNode):
    ...
    def _check_lottery_sim_criteria(self, sim_info):
        ...
        if sim_info.household.hidden:
            return False
        if sim_info.household.is_player_household:
            return False
        return True
    ...
    def _setup_lottery(self):
        ...
        self._end_alarm_handle = alarms.add_alarm(self, time_until_end,
          (self._end_lottery),
          cross_zone=True)
