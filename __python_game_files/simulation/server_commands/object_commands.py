...
# Size of source mod 2**32: 82244 bytes
...
def create_objects_in_grid_by_definition(def_id: int, amount: int, start_pos_x: int=None, start_pos_z: int=None, grid_size_x: int=None, grid_size_z: int=None, _connection=None):
