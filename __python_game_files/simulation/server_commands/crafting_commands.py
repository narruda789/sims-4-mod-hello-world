...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\server_commands\crafting_commands.py
# Compiled at: 2020-05-06 18:26:00
...
import crafting.crafting_process, services, sims4.commands
...
def create_recipe(recipe: TunableInstanceParam(Types.RECIPE), opt_sim: OptionalTargetParam=None, _connection=None):
    ...
    if craftable is None:
        ...
        return False
    CarryingObject.snap_to_good_location_on_floor(craftable, starting_transform=(sim.transform),
...
def show_quality(opt_sim: OptionalTargetParam=None, _connection=None):
    ...
    quality_state_strings = [
     'None', 'Poor', 'Normal', 'Outstanding']
