...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\server_commands\aging_commands.py
...
from sims.aging.aging_tuning import AgingTuning, AgeSpeeds
...
def set_age_speed_option(speed: AgeSpeeds, _connection=None):
