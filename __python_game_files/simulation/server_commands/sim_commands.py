...
# Size of source mod 2**32: 94014 bytes
...
def spawn_max_sims(_connection=None):
    ...
    num = services.sim_spawner_service().npc_soft_cap - instantiated_sims
    if num > 0:
...
def get_buffs_ids_for_outfit--- This code section failed: ---
 ...
 L.1572         0  LOAD_GLOBAL              get_optional_target
                2  LOAD_FAST                'opt_sim'
                4  LOAD_FAST                '_connection'
                6  CALL_FUNCTION_2       2  '2 positional arguments'
                8  STORE_FAST               'sim'

 L.1573        10  LOAD_FAST                'sim'
               12  LOAD_CONST               None
               14  COMPARE_OP               is
               16  POP_JUMP_IF_FALSE    22  'to 22'

 L.1574        18  LOAD_CONST               False
               20  RETURN_VALUE     
             22_0  COME_FROM            16  '16'

 L.1576        22  LOAD_GLOBAL              getattr
 ...
 L.1577        38  LOAD_FAST                'category'
               40  LOAD_CONST               None
               42  COMPARE_OP               is-not
               44  POP_JUMP_IF_FALSE   194  'to 194'

 L.1578        46  LOAD_FAST                'sim'
