...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\server\pick_info.py
# Compiled at: 2021-03-12 21:57:12
# Size of source mod 2**32: 7232 bytes
import enum, services, sims4.math
...
PICK_TRAVEL = frozenset([
 PickType.PICK_TERRAIN,
 PickType.PICK_FLOOR,
 PickType.PICK_UNKNOWN,
 PickType.PICK_STAIRS,
 PickType.PICK_FOUNDATION,
 PickType.PICK_POOL_SURFACE,
 PickType.PICK_POOL_TRIM,
 PickType.PICK_POOL_EDGE,
 PickType.PICK_FOUNTAIN])
PICK_UNGREETED = frozenset([
 PickType.PICK_ROOF,
 PickType.PICK_WALL,
 PickType.PICK_FLOOR,
 PickType.PICK_STAIRS,
...
class PickInfo:
    __slots__ = ('_location', '_lot_id', '_level', '_routing_surface', '_type', '_target',
                 '_modifiers', '_ignore_neighborhood_id')
    ...
    def get_zone_id_from_pick_location(self):
        ...
        if services.active_lot_id() == lot_id:
