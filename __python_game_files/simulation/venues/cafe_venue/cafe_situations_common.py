...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\venues\cafe_venue\cafe_situations_common.py
...
class _PreOrderCoffeeState(CommonSituationState):
    ...
    def on_activate(self, reader=None):
        ...
        self._create_or_load_alarm(ORDER_COFFEE_TIMEOUT, (self._wait_to_order_duration.random_float()), (lambda _: self.timer_expired()),
