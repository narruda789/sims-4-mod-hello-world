...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\venues\civic_policies\venue_civic_policy_provider.py
# Compiled at: 2022-07-21 21:49:30
# Size of source mod 2**32: 8549 bytes
    ...
    def _post_change(self):
        ...
        if self._recursion_count <= 0:
            ...
            if self.active_venue_type != self._new_venue_type:
                ...
                services.venue_game_service().change_provider_venue_type(self, self.active_venue_type, self.source_venue_type)

    def _post_forced_change(self):
        self._select_balloted_policies()
        if not self.get_enacted_policies():
            self.enact(self.get_policy_instance_for_venue(self.source_venue_type))
