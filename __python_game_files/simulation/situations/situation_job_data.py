...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\situation_job_data.py
# Compiled at: 2018-10-23 18:29:17
# Size of source mod 2**32: 15803 bytes
import random
from situations.situation_job import JobChurnOperation
import alarms, clock, date_and_time, services, sims4.log
...
class SituationJobData:
    ...
    def __init__(self, job_type, default_role_state_type, situation):
        ...
        if self._get_churn():
            self._churn_alarm_handle = alarms.add_alarm(self, churn_interval,
              (self._churn),
              repeating=True,
    ...
    def _get_churn(self):
        return self._job_type.churn is None or self._job_type.churn.auto_populate_by_time_of_day or None
        return self._job_type.churn

    def _get_shifts(self):
        return self._job_type.sim_shifts is None or self._job_type.sim_shifts.shift_times_and_staffing or None
    ...
    def _churn(self, alarm_handle=None):
        ...
        if num_total < desired_interval.min:
            ...
            if num_here > desired_interval.max:
                op = JobChurnOperation.REMOVE_SIM
                over_max = True
            else:
                if sims4.random.random_chance(churn.chance_to_add_or_remove_sim):
                    options = []
                ...
                elif op == JobChurnOperation.ADD_SIM:
                    ...
                    if op == JobChurnOperation.REMOVE_SIM:
