...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\situation_goal_interaction_time.py
# Compiled at: 2022-08-26 18:13:12
# Size of source mod 2**32: 9404 bytes
import alarms
...
class SituationGoalInteractionTime(SituationGoal):
    ...
    def max_iterations(cls, inst):
        if inst is not None:
            return inst._goal_test.duration
        return cls._goal_test.duration
