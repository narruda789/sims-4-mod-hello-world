...
import alarms, services, sims4.tuning.instances, situations.bouncer.bouncer
...
class NPCHostedBirthdayParty(SituationComplexCommon):
    ...
    @classmethod
    def _states(cls):
        return (SituationStateData(1, _BirthdayPreperationSituationState, factory=(cls.preparation_situation_state)),
         SituationStateData(2, _AgeUpHostSituationState, factory=(cls.age_up_host_situation_state)),
         SituationStateData(3, _AgeUpHostBackupSituationState, factory=(cls.age_up_host_backup_situation_state.situation_state)),
         SituationStateData(4, _PostAgeUpSituationState, factory=(cls.post_age_up_situation_state)))
...
sims4.tuning.instances.lock_instance_tunables(NPCHostedBirthdayParty, exclusivity=(situations.bouncer.bouncer_types.BouncerExclusivityCategory.NORMAL),
