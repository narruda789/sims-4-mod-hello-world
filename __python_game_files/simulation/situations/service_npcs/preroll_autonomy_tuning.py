...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\service_npcs\preroll_autonomy_tuning.py
# Compiled at: 2016-04-18 18:17:07
# Size of source mod 2**32: 4793 bytes
...
class ServicePrerollAutonomy(HasTunableFactory, AutoFactoryInit):
    ...
    def run_preroll(self, sim):
        ...
        autonomy_request = AutonomyRequest(sim, autonomy_mode=FullAutonomy, skipped_static_commodities=(sim.autonomy_component.standard_static_commodity_skip_set),
