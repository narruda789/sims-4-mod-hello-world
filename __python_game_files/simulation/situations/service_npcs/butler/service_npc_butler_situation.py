...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\service_npcs\butler\service_npc_butler_situation.py
# Compiled at: 2021-09-01 13:58:18
# Size of source mod 2**32: 15090 bytes
...
class ServiceNpcButlerSituation(SituationComplexCommon):
    INSTANCE_TUNABLES = {'_butler_job':TunableSituationJobAndRoleState(description='\n                The job for Butler in this situation and the \n                corresponding starting role state for service Sim.\n                ',
     ...
     'butler_states':TunableTuple(cleaning_state=_ButlerCleaningState.TunableFactory(description='\n                Situation State for the butler to run all the clean \n                interactions.\n                '),
    ...
    @classmethod
    def _states(cls):
        return (SituationStateData(1, _ButlerDefaultState, factory=(cls.butler_states.default_state)),
         SituationStateData(2, _ButlerCleaningState, factory=(cls.butler_states.default_state)),
         SituationStateData(3, _ButlerGardeningState, factory=(cls.butler_states.default_state)),
         SituationStateData(4, _ButlerChildcareState, factory=(cls.butler_states.default_state)),
         SituationStateData(5, _ButlerRepairState, factory=(cls.butler_states.default_state)),
         SituationStateData(6, LeaveSituationState, factory=(cls.butler_states.default_state)))
...
lock_instance_tunables(ServiceNpcButlerSituation, creation_ui_option=(SituationCreationUIOption.NOT_AVAILABLE),
