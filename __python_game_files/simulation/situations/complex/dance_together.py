...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\dance_together.py
...
class _DanceState(CommonInteractionCompletedSituationState):
    ...
    def on_activate(self, reader=None):
        ...
        aop = AffordanceObjectPair((self.owner.dance_affordance), None,
...
class DanceTogetherSituation(GroupDanceSituation):
    ...
    def _states(cls):
        ...
        situation_states = [
         SituationStateData(2, _DanceState, factory=(cls.dance_state))]
    ...
    def get_jig_definition(self):
        ...
        filter_result_list = sim_filter_service.submit_filter((self.dance_member_job.filter), None,
