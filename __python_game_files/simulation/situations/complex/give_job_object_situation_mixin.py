...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\give_job_object_situation_mixin.py
# Compiled at: 2019-03-01 13:48:14
        ...
        for obj_id, owner_id in zip(obj_ids, owner_ids):
            if obj_id is None:
                ...
                if owner_id is None:
                    ...
                    continue
                services.sim_info_manager().is_sim_id_valid(owner_id) or logger.warn('{} failed to load saved object with object id {}: sim with id {} has been culled', type(self), obj_id, owner_id)
                continue
