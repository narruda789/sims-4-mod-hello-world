...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\group_dance\dance_battle_situation.py
...
class DanceBattleSituation(GroupDanceSituation):
    ...
    def _states(cls):
        ...
        situation_states = [
         SituationStateData(2, _DanceBattleDanceState, cls.dance_state),
         SituationStateData(3, _DanceBattleWatchState, cls.watch_state),
         SituationStateData(4, _DanceBattleReactState, cls.react_state)]
