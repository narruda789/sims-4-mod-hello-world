...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\vampire_nighttime_situation.py
# Compiled at: 2019-03-13 14:16:28
# Size of source mod 2**32: 15062 bytes
...
from tag import Tag
import event_testing, interactions, services, sims4.log, sims4.tuning.instances, sims4.tuning.tunable, situations.bouncer, tag
...
class _BiteState(VampireInterruptableStateMixin):
    ...
    def on_activate(self, reader=None):
        ...
        vampire_sim = self.owner.vampire_sim()
        context = interactions.context.InteractionContext(vampire_sim, (interactions.context.InteractionContext.SOURCE_SCRIPT),
...
class VampireNighttimeSituation(WalkbyLimitingTagsMixin, SituationComplexCommon):
    ...
    @classmethod
    def _states(cls):
        return (SituationStateData(1, _VampireArrivalState, factory=(cls.vampire_job.arrival_state)),
         SituationStateData(2, _BreakInState, factory=(cls.vampire_job.break_in_state)),
         SituationStateData(3, _BiteState, factory=(cls.vampire_job.bite_state)),
         SituationStateData(4, _LeaveState),
         SituationStateData(5, _LeaveStartledState, factory=(cls.vampire_job.leave_startled_state)))

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (cls.vampire_job.situation_job,
          cls.vampire_job.arrival_state)]
...
sims4.tuning.instances.lock_instance_tunables(VampireNighttimeSituation, exclusivity=(situations.bouncer.bouncer_types.BouncerExclusivityCategory.WALKBY_SNATCHER),
