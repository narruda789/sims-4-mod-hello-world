...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\invite_to_situation.py
...
import services, sims4.tuning.instances, sims4.tuning.tunable, situations.bouncer, situations.situation_types, venues
...
sims4.tuning.instances.lock_instance_tunables(InviteToSituation, exclusivity=(situations.bouncer.bouncer_types.BouncerExclusivityCategory.PRE_VISIT),
