...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\prisoner_escort_situation.py
# Compiled at: 2020-07-30 21:33:13
# Size of source mod 2**32: 8357 bytes
...
class PrisonerEscortSituation(SituationComplexCommon):
    ...
    @classmethod
    def _states(cls):
        return (SituationStateData(1, _EscortState, factory=(cls.escort_state)),
         SituationStateData(2, _DespawnState, factory=(cls.despawn_state)))

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [(cls.escort_job_and_role_state.job, cls.escort_job_and_role_state.role_state),
         (
          cls.prisoner_job_and_role_state.job, cls.prisoner_job_and_role_state.role_state)]
    ...
    def start_situation(self):
        ...
        if escort_sim is not None:
            if prisoner_sim is not None:
                escort_sim.sim_info.is_npc and prisoner_sim.sim_info.is_npc or services.get_persistence_service().lock_save(self)
