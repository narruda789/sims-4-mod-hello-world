...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\ambient\ghost_situation.py
# Compiled at: 2015-04-03 17:43:53
...
import alarms, clock, sims4.tuning.tunable, situations.bouncer, situations.situation_complex
...
sims4.tuning.instances.lock_instance_tunables(GhostSituation, exclusivity=(situations.bouncer.bouncer_types.BouncerExclusivityCategory.NORMAL),
