...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\ambient\open_streets_autonomy_situation.py
...
from tag import Tag
import services, sims4.tuning.tunable, situations.bouncer, situations.situation_complex
...
sims4.tuning.instances.lock_instance_tunables(OpenStreetsAutonomySituation, exclusivity=(situations.bouncer.bouncer_types.BouncerExclusivityCategory.WALKBY),
...
class _DoStuffState(SituationState):
    ...
    def on_activate(self, reader=None):
        ...
        self._create_or_load_alarm(DO_STUFF_TIMEOUT, (self.owner.do_stuff_timeout), (lambda _: self.timer_expired()),
