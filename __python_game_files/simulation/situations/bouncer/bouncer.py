            ...
            for unfulfilled_index in range(Bouncer.MAX_UNFULFILLED_INDEX):
                ...
                for request in candidate_requests:
                    if not request._requires_spawning:
                        ...
                        filter_results = sim_filter_service.submit_filter((request._sim_filter), callback=None,
                          sim_constraints=(list(candidate_sim_ids)),
            ...
            for unfulfilled_index in range(Bouncer.MAX_UNFULFILLED_INDEX):
                ...
                for request in candidate_requests:
                    ...
                    if request._accept_looking_for_more_work:
                        ...
                        filter_results = sim_filter_service.submit_filter((request._sim_filter), callback=None,
                          sim_constraints=(list(candidate_sim_ids)),
                          blacklist_sim_ids=(request._get_blacklist()),
                          requesting_sim_info=(request._requesting_sim_info),
                          allow_yielding=False,
                          additional_filter_terms=(request.get_additional_filter_terms()),
                          gsi_source_fn=(self.get_sim_filter_gsi_name))
