...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\custom_states\custom_states_situation.py
# Compiled at: 2022-02-09 13:21:47
# Size of source mod 2**32: 11993 bytes
import services
...
class CustomStatesSituation(BaseCustomStatesSituation):
    INSTANCE_TUNABLES = {'_situation_states':TunableMapping(description='\n            A tunable mapping between situation state keys and situation states.\n            ',
       ...
       value_type=TunableCustomStatesSituationStateSnippet(description='\n                The situation state that is tied to this key.\n                '),
       tuning_group=GroupNames.CORE), 
