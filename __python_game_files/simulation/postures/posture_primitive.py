...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\postures\posture_primitive.py
# Compiled at: 2016-11-04 14:11:24
# Size of source mod 2**32: 11751 bytes
        ...
        if not multi_sim_posture_transition:
            ...
            def end_posture_on_same_track(timeline):
                if self._prev_posture is not None:
                    if self._prev_posture is not posture:
