...
class TransitionSequenceController:
 ...
 L.1238         0  BUILD_LIST_0          0 
                2  STORE_FAST               'sims_to_reset'

 L.1239         4  LOAD_CONST               False
                6  STORE_FAST               'moved_social_group'

 L.1240      8_10  SETUP_LOOP          366  'to 366'
               12  LOAD_FAST                'self'
 ...
 L.1241        32  LOAD_FAST                'derailed_reason'
               34  LOAD_CONST               None
               36  COMPARE_OP               is
 ...
 L.1242        50  CONTINUE             22  'to 22'
             52_0  COME_FROM            48  '48'

 L.1244        52  LOAD_FAST                'self'
 ...
 L.1251        68  SETUP_LOOP          164  'to 164'
               70  LOAD_FAST                'self'
 ...
 L.1255       112  LOAD_DEREF               'final_destination'
              114  LOAD_CONST               None
              116  COMPARE_OP               is-not
              118  POP_JUMP_IF_FALSE   164  'to 164'

 L.1261       120  LOAD_CLOSURE             'final_destination'
              122  BUILD_TUPLE_1         1 
 ...
 L.1270       232  LOAD_CONST               None
              234  LOAD_FAST                'self'
              236  STORE_ATTR               _original_interaction_target

 L.1271       238  LOAD_CONST               False
              240  LOAD_FAST                'self'
 ...
 L.1273       244  LOAD_FAST                'moved_social_group'
 ...
 L.1280       300  LOAD_GLOBAL              DerailReason
 ...
 L.1289       366  SETUP_LOOP          396  'to 396'
              368  LOAD_FAST                'sims_to_reset'
              370  GET_ITER         
              372  FOR_ITER            394  'to 394'
              374  STORE_FAST               'sim'

 L.1290       376  LOAD_FAST                'self'
                ...
                def is_valid_destination():
                    ...
                    if target_sim is None:
                        ...
                        if dest_body_target is None:
                            return True
                        return dest_body_posture_type.is_valid_destination_target(sim, dest_body_target, adjacent_sim=target_sim,
                          adjacent_target=target_posture_target) or False
