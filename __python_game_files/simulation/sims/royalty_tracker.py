...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\royalty_tracker.py
# Compiled at: 2021-09-01 13:58:18
# Size of source mod 2**32: 27916 bytes
...
from sims4.tuning.tunable import TunableEnumEntry, Tunable, TunableMapping, HasTunableReference, TunableTuple, OptionalTunable, TunableRange, TunableReference, TunablePackSafeReference
from sims4.utils import classproperty
from tunable_multiplier import TunableMultiplier
from ui.ui_dialog_notification import UiDialogNotification
import services, sims4.log, sims4.random, tag
...
class RoyaltyTracker(SimInfoTracker):
    ...
    def load(self, data):
        for royalty_data in data.royalties:
            ...
            self.start_royalty(royalty_type=(RoyaltyType(royalty_data.royalty_type)), royalty_guid64=(royalty_data.royalty_guid64),
    ...
    def on_lod_update(self, old_lod, new_lod):
        if new_lod < self._tracker_lod_threshold:
            ...
            if old_lod < self._tracker_lod_threshold:
                sim_msg = services.get_persistence_service().get_sim_proto_buff(self._sim_ref().id)
...
class RoyaltyAlarmManager:
    ...
    def start_schedule(self):
        ...
        LifestyleBrandTracker.PAYMENT_SCHEDULE(start_callback=(self._lifestyle_brand_alarm_tick), schedule_immediate=False)
