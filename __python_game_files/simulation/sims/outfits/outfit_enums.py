...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\outfits\outfit_enums.py
# Compiled at: 2022-07-21 21:49:30
# Size of source mod 2**32: 7753 bytes
...
REGULAR_OUTFIT_CATEGORIES = (
 OutfitCategory.EVERYDAY, OutfitCategory.FORMAL, OutfitCategory.ATHLETIC,
 OutfitCategory.SLEEP, OutfitCategory.PARTY, OutfitCategory.SWIMWEAR,
 OutfitCategory.HOTWEATHER, OutfitCategory.COLDWEATHER)
TODDLER_PROHIBITED_OUTFIT_CATEGORIES = frozenset((OutfitCategory.ATHLETIC,))
HIDDEN_OUTFIT_CATEGORIES = (
 OutfitCategory.CAREER, OutfitCategory.SITUATION, OutfitCategory.SPECIAL, OutfitCategory.BATUU)
NON_RANDOMIZABLE_OUTFIT_CATEGORIES = (
 OutfitCategory.BATHING,)
...
CLOTHING_BODY_TYPES = (
 BodyType.CUMMERBUND, BodyType.BROW_RING_LEFT, BodyType.BROW_RING_RIGHT,
 BodyType.EARRINGS, BodyType.FULL_BODY, BodyType.GLASSES,
 BodyType.GLOVES, BodyType.HAT, BodyType.INDEX_FINGER_LEFT,
 BodyType.INDEX_FINGER_RIGHT, BodyType.LIP_RING_LEFT,
 BodyType.LOWER_BODY, BodyType.MIDDLE_FINGER_LEFT,
 BodyType.MIDDLE_FINGER_RIGHT, BodyType.NECKLACE,
 BodyType.NOSE_RING_LEFT, BodyType.NOSE_RING_RIGHT,
 BodyType.RING_FINGER_RIGHT, BodyType.SHOES, BodyType.SOCKS,
 BodyType.TIGHTS, BodyType.UPPER_BODY, BodyType.WRIST_LEFT,
 BodyType.WRIST_RIGHT)