...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\multi_motive_buff_tracker.py
# Compiled at: 2020-06-05 18:24:47
...
class MultiMotiveBuffTracker:
    ...
    def setup_callbacks(self):
        ...
        for commodity_type, threshold in self._multi_motive_buff_motives.items():
            ...
            elif self._watcher_handle is None:
    ...
    def cleanup_callbacks(self):
        ...
        if self._watcher_handle is not None:
            if tracker.has_watcher(self._watcher_handle):
