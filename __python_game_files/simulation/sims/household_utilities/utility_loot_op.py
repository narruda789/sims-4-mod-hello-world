...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\household_utilities\utility_loot_op.py
# Compiled at: 2020-03-19 14:58:14
...
import game_services, services, sims4
...
class UtilityModifierOp(BaseLootOperation):
    ...
    FACTORY_TUNABLES = {'utility':TunableEnumEntry(description='\n            The utility we want to shut off.\n            ',
     ...
     'action':TunableVariant(description='\n            Action to change utility.\n            ',
       ...
       default='shut_off'), 
     'locked_args':{'subject': ParticipantType.Lot}}
