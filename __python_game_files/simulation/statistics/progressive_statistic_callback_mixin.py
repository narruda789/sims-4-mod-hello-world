...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\statistics\progressive_statistic_callback_mixin.py
# Compiled at: 2020-06-25 15:49:17
...
class ProgressiveStatisticCallbackMixin:
    ...
    def refresh_threshold_callback(self):
        ...
        if self.decay_enabled:
            self._decay_callback_handle = self.create_and_add_callback_listener((self._get_previous_level_threshold()), (self._callback_handler), should_seed=False)
        self._destory_callback_handle()
        self._callback_handle = self.create_and_add_callback_listener((self._get_next_level_threshold()), (self._callback_handler), should_seed=False)
    ...
    def _get_previous_level_threshold(self):
        return Threshold(self._get_previous_level_bound(), operator.lt)
