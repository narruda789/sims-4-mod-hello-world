...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\statistics\statistic.py
# Compiled at: 2020-11-20 03:10:25
...
class Statistic(HasTunableReference, BaseStatistic, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.STATISTIC)):
    INSTANCE_TUNABLES = {'initial_tuning':TunableTuple(description=' \n            The Initial value for this statistic. Can either be a single\n            value, range, or use auto satisfy curve to determine initial\n            value.  Range value will take precedence over single value\n            range.\n            ',
       ...
       default_lower=0,
       default_upper=100)),
       _initial_value=Tunable(description='\n                The initial value for this stat.\n                ',
       tunable_type=int,
       default=0)), 
     ...
     'max_value_tuning':Tunable(description='\n            The maximum value that this statistic can reach.\n            ',
       tunable_type=int,
       default=100,
       export_modes=ExportModes.All), 
    ...
    def remove_statistic_static_modifier(self, modifier):
        if self._static_modifiers is not None:
            if modifier in self._static_modifiers:
