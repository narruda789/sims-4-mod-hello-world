...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\automation\constants.py
# Compiled at: 2022-08-26 18:13:12
# Size of source mod 2**32: 66566 bytes
...
IGNORED_ATTRIBUTES = [
 'MODULE_TUNABLES']
prefix_map = {Constants.LocalizationStrings: 'LOCSTR', 
 Constants.Interactions: 'CLASSN', 
 Constants.ObjectDefinitions: 'OBJ', 
 Constants.Misc: 'MISC', 
 Constants.ResourceIds: 'RESOURCE', 
 Constants.LotDescriptions: 'LOTDESC', 
 Constants.ClubSeeds: 'CLUBSEED', 
 Constants.Recipes: 'RECIPE', 
 Constants.Buffs: 'BUFF', 
 Constants.Situations: 'SITUATION', 
 Constants.SituationJobs: 'SITUATIONJOB'}
            ...
            if not attribute in IGNORED_ATTRIBUTES:
                ...
                for idx, raw_value in enumerate(list_values):
                    if isinstance(raw_value, (int, str, float, bool)) or raw_value is None:
                        ...
                        if visual_type_override_data is not None:
                            if visual_type_override_data.tooltip_text is not None:
