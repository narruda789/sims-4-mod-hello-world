...
# Size of source mod 2**32: 125919 bytes
...
class Career(HasTunableReference, careers.career_base.CareerBase, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.CAREER)):
    ...
    INSTANCE_TUNABLES = {'career_category':TunableEnumEntry(description='\n            Category for career, this will be used for aspirations and other\n            systems which should trigger for careers categories but not for\n            others.\n            ',
     ...
     'career_not_selectable_tooltip':OptionalTunable(description='\n            If enabled, this tooltip will be displayed in the Career Selector\n            dialog next to the Select button. Only shown for a career that is \n            not selectable by the active Sim.\n            ',
 ...
 L.1437         0  LOAD_CONST               0
                2  STORE_FAST               'max_user_level'

 L.1438         4  LOAD_FAST                'cls'
 ...
 L.1440        16  SETUP_LOOP          100  'to 100'
               18  LOAD_FAST                'stack'
               20  POP_JUMP_IF_FALSE    98  'to 98'

 L.1441        22  LOAD_FAST                'stack'
               24  LOAD_METHOD              pop
 ...
 L.1444        48  LOAD_FAST                'track'
               50  LOAD_ATTR                branches
               52  POP_JUMP_IF_FALSE    86  'to 86'

 L.1445        54  SETUP_LOOP           96  'to 96'
               56  LOAD_FAST                'track'
 ...
 L.1450       100  LOAD_FAST                'max_user_level'
              102  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `COME_FROM' instruction at offset 98_0
    ...
    def _append_career_info_pb(msg, sim_info, career, current_track, new_level, benefit_description=None, is_selectable=True):
        ...
        if career.career_not_selectable_tooltip is not None:
            career_info_msg.not_selectable_tooltip = career.career_not_selectable_tooltip()
                    ...
                    if test_result and sim_info.career_tracker.get_career_by_uid(career_level.career.guid64) is None:
                        if career_level.track not in career_tracks_added:
                            ...
                            Career._append_career_info_pb(msg, sim_info,
                              ...
                              is_selectable=(is_selectable_test_result.result))
...
class CareerSelectElement(interactions.utils.interaction_elements.XevtTriggeredElement):
 ...
 L.2526        12  LOAD_CONST               None
               14  RETURN_VALUE     
             16_0  COME_FROM            10  '10'

 L.2528        16  LOAD_FAST                'self'
 ...
 L.2530        30  LOAD_FAST                'participants'
               32  LOAD_CONST               None
               34  COMPARE_OP               is
 ...
 L.2532        72  LOAD_CONST               None
               74  RETURN_VALUE     
             76_0  COME_FROM            48  '48'

 L.2534        76  LOAD_GLOBAL              len
 ...
 L.2538       122  LOAD_GLOBAL              getattr
 ...
 L.2541       148  LOAD_GLOBAL              Career
              150  LOAD_ATTR                NUM_CAREERS_PER_DAY
              152  STORE_FAST               'num'

 L.2542       154  LOAD_FAST                'self'
 ...
 L.2543       170  LOAD_CONST               0
              172  STORE_FAST               'num'
            174_0  COME_FROM           168  '168'

 L.2545       174  LOAD_DEREF               'sim_info'
 ...
 L.2547       194  LOAD_GLOBAL              Career
              196  LOAD_ATTR                get_join_career_pb
              198  LOAD_DEREF               'sim_info'

 L.2548       200  LOAD_FAST                'num'

 L.2549       202  LOAD_FAST                'default_career_selection_data'
 ...
 L.2550       210  LOAD_GLOBAL              Distributor
 ...
 L.2556       274  LOAD_CLOSURE             'career'
 ...
 L.2566       340  LOAD_CONST               None
              342  STORE_FAST               'dialog'

 L.2567       344  LOAD_DEREF               'career'
 ...
 L.2568       358  SETUP_LOOP          406  'to 406'
 ...
 L.2569       372  LOAD_FAST                'career_dialog_test'
 ...
 L.2571       386  LOAD_FAST                'career_dialog_test'
 ...
 L.2579       462  LOAD_DEREF               'sim_info'
 ...
 L.2583       530  SETUP_LOOP          566  'to 566'
