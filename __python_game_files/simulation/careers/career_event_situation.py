...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\careers\career_event_situation.py
...
import distributor.system, services, sims4.resources
...
lock_instance_tunables(CareerEventSituation, exclusivity=(BouncerExclusivityCategory.NEUTRAL),
  creation_ui_option=(SituationCreationUIOption.NOT_AVAILABLE),
  time_jump=SITUATION_TIME_JUMP_DISALLOW)
