...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\careers\prep_tasks\prep_tasks_tracker.py
# Compiled at: 2018-10-05 18:44:21
# Size of source mod 2**32: 7290 bytes
import operator
...
class PrepTaskTracker:
    ...
    def send_prep_task_update(self):
        return services.current_zone().is_zone_shutting_down or self._sim_info.valid_for_distribution or None
