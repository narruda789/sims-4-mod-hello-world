...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\careers\detective\detective_career_apb.py
# Compiled at: 2018-04-23 20:09:32
# Size of source mod 2**32: 6838 bytes
...
class ZoneDirectorApb(CareerEventZoneDirectorProxy):
    ...
    def create_situations_during_zone_spin_up(self):
        ...
        if career is not None:
            ...
            self._persisted_decoy_sim_ids = None
            self._apb_situation_id = situation_manager.create_situation((self.apb_situation), guest_list=guest_list,
