...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\careers\career_location.py
# Compiled at: 2022-04-20 20:37:17
# Size of source mod 2**32: 10455 bytes
import random
...
class TunableCareerLocationVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, company=CareerLocationRandomCompany.TunableFactory(), 
         venue=CareerLocationVenue.TunableFactory(), 
         service_npc=CareerLocationServiceNpc.TunableFactory(), 
         default='company', **kwargs)