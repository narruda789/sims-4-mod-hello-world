...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\rewards\reward.py
# Compiled at: 2020-02-24 20:57:41
...
def _give_reward_payout(reward_instance, sim_info, reward_destination, disallowed_reward_types=(), force_rewards_to_sim_info_inventory=False):
    ...
    for reward in reward_instance.rewards:
        ...
        if chosen_reward_type is not None:
            ...
            reward.open_reward(sim_info, reward_destination=reward_destination,
              force_rewards_to_sim_info_inventory=force_rewards_to_sim_info_inventory,
              reward_source=reward_instance)
