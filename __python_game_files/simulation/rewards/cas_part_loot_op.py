...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\rewards\cas_part_loot_op.py
# Compiled at: 2020-06-04 19:13:07
...
class CASUnlockLootOp(BaseLootOperation):
    FACTORY_TUNABLES = {'cas_part_source': TunableVariant(description='\n            The source from which we should get the cas parts.\n            ',
                          reference=(CASPartFromReference.TunableFactory()),
                          participant=(CASPartFromParticipant.TunableFactory()))}
