...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\rabbit_hole\rabbit_hole.py
# Compiled at: 2022-07-21 21:49:30
# Size of source mod 2**32: 17482 bytes
import alarms, date_and_time, id_generator
...
class RabbitHole(HasTunableReference, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.RABBIT_HOLE)):
    ...
    def is_valid_to_restore(self, sim_info):
        if self.is_active():
            if self.time_tracking_policy != RabbitHoleTimingPolicy.NO_TIME_LIMIT:
                if self.time_remaining_on_load is None:
