...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\adoption\adoption_interactions.py
...
import element_utils, interactions, services
...
class AdoptionSuperInteraction(SuperInteraction, NameOffspringSuperInteractionMixin):
    ...
    def _name_and_create_adoptee_gen(self, timeline):
        ...
        if adopted_sim_info is None:
            ...
            adopted_sim_info, _ = adoption_service.create_adoption_sim_info(adopted_sim_info, household=(parent_a.household),
