...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\global_policies\global_policy_effects.py
# Compiled at: 2019-02-26 20:48:57
...
class GlobalPolicyEffectVariants(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, shut_off_utilities=ScheduleUtilityShutOff.TunableFactory(), 
         bill_reduction=BillReduction.TunableFactory(), 
