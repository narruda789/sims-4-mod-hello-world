...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\business\business_service.py
# Compiled at: 2018-04-27 15:13:19
# Size of source mod 2**32: 21976 bytes
...
import alarms, game_services, persistence_error_types, services, sims4.log
...
class BusinessService(Service):
    ...
    def _start_off_lot_churn_alarm(self):
        self._off_lot_churn_alarm_handle = alarms.add_alarm(self, create_time_span(hours=(BusinessService.HOURS_BETWEEN_OFF_LOT_SIMULATIONS)),
    ...
    def get_retail_manager_for_zone(self, zone_id=None):
        ...
        if business_manager is not None:
            if business_manager.business_type == BusinessType.RETAIL:
    ...
    def load_legacy_data(self, household, household_proto):
        ...
        if hasattr(household_proto.gameplay_data, 'retail_data'):
            ...
            return legacy_save_data or None
