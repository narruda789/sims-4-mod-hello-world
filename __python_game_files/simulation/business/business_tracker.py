...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\business\business_tracker.py
# Compiled at: 2017-04-26 17:37:49
...
import game_services, services, sims4.log
    ...
    def make_owner(self, owner_household_id, business_zone_id):
        if self.business_type == BusinessType.RETAIL:
            ...
            if self.business_type == BusinessType.RESTAURANT:
                ...
                if self.business_type == BusinessType.VET:
