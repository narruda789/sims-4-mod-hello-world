...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\narrative\narrative_loot_ops.py
# Compiled at: 2019-01-25 18:51:13
...
class NarrativeLootOp(BaseLootOperation):
    FACTORY_TUNABLES = {'op_type': TunableVariant(trigger_event=(_TriggerEventOp.TunableFactory()),
                  start_narrative=(_StartNarrativeOp.TunableFactory()),
                  end_narrative=(_EndNarrativeOp.TunableFactory()),
                  reset_completion=(_ResetNarrativeCompletionOp.TunableFactory()),
