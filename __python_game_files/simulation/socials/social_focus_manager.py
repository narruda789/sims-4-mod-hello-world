...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\socials\social_focus_manager.py
# Compiled at: 2016-04-14 16:24:14
# Size of source mod 2**32: 11640 bytes
from interactions.utils.sim_focus import SimFocus, get_next_focus_id
from socials.geometry import SocialGeometry
import interactions.utils.sim_focus, sims4.log, sims4.math, services
...
class SocialFocusManager:
    ...
    def __init__(self, social_group):
        ...
        self._sim_focus_info = {SimFocus.LAYER_SUPER_INTERACTION: {}, 
         SimFocus.LAYER_INTERACTION: {}}
