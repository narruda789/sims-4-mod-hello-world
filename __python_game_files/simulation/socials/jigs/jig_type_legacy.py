...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\socials\jigs\jig_type_legacy.py
# Compiled at: 2019-01-30 13:11:23
...
class SocialJigLegacy(AutoFactoryInit, HasTunableSingletonFactory):
    ...
    def get_transforms_gen(self, actor, target, fallback_routing_surface=None, fgl_kwargs=None, **kwargs):
        ...
        translation_a, orientation_a, translation_b, orientation_b, routing_surface = generate_jig_polygon(actor.location, sims4.math.Vector2.ZERO(), 0, target.location, sims4.math.Vector2(0, offset), sims4.math.PI,
 reserved_space_a.left, reserved_space_a.right, reserved_space_a.front, reserved_space_a.back,
 reserved_space_b.left, reserved_space_b.right, reserved_space_b.front, reserved_space_b.back, positioning_type=self.jig_positioning_type, 
         fallback_routing_surface=fallback_routing_surface, **fgl_kwargs)
