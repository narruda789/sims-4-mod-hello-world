...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\socials\interrogation_group.py
    ...
    def _interrogation_statistic_callback(self, stat_type, old_value, new_value):
        ...
        if self._initiating_sim is not None:
            if self._target_sim is not None:
                if self.interrogation_end_interaction_data.interrogation_statistic_threshold.compare(new_value):
