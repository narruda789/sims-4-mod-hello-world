...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\gsi_handlers\lot_handlers.py
...
import services, sims4, build_buy
        ...
        for lot_owner_info in neighborhood_proto.lots:
            ...
            if zone_id is not None:
                ...
                if venue_tuning is not None:
                    ...
                    cur_info = {'neighborhood':neighborhood_proto.name,  'region_id':neighborhood_proto.region_id, 
