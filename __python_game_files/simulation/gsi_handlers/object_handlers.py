...
# Size of source mod 2**32: 38706 bytes
...
with object_manager_schema.add_has_many('parts', GsiGridSchema) as (sub_schema):
    ...
    sub_schema.add_field('disabling_states', label='Disabling States', width=1.5)
                ...
                if 'on_active_lot' in filter_list:
                    ...
                    if cur_obj.objectrelationship_component is not None:
                        ...
                        if len(sims_in_relationships) == 0:
                            relationship_entry = {'relationshipNumber':"This object hasn't formed any relationships, but could if it wanted to.", 
                             'simValue':'', 
                             'relationshipValue':'', 
                        ...
                        for sim_number, sim_id in enumerate(sims_in_relationships):
                            ...
                            relationship_entry = {'relationshipNumber':relationship_number_value, 
                             'simValue':sim_name, 
                        ...
                        relationship_entry = {'relationshipNumber':'This object has no capacity for love.', 
                         'simValue':'', 
                         'relationshipValue':'', 
                         'relationshipStatInfo':''}
                        ret_dict['object_relationships'].append(relationship_entry)
