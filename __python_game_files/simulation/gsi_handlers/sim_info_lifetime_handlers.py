...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\gsi_handlers\sim_info_lifetime_handlers.py
# Compiled at: 2017-03-08 19:48:49
...
archiver = GameplayArchiver('sim_info_lifetime', sim_info_lifetime_archive_schema,
...
def archive_sim_info_event(sim_info, event_type):
    ...
    entry = {'game_time':str(services.time_service().sim_now), 
     'total_sim_info_count':str(total_sim_info_count), 
     ...
     'household_name':str(household.name) if household is not None else 'NO HOUSEHOLD'}
