...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sickness\sickness_service.py
# Compiled at: 2020-04-13 20:24:31
# Size of source mod 2**32: 5969 bytes
import random
...
import alarms, date_and_time, services, sims4, zone_types
...
class SicknessService(Service):
    ...
    def _initialize_alarm(self):
        ...
        self._alarm_handle = alarms.add_alarm(self, initial_time_span,
