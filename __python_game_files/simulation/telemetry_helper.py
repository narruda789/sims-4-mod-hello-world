...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\telemetry_helper.py
# Compiled at: 2019-04-19 12:45:44
# Size of source mod 2**32: 12960 bytes
import collections
...
import alarms, enum, objects.components, services, sims4.telemetry
...
def _write_common_data(hook, sim_info=None, household=None, session_id=None, record_position=False):
    ...
    household_id = 0
    if sim_info is not None and not hook.valid_for_npc:
        if sim_info.is_npc:
            ...
            if household is None:
            ...
            elif sim_info.has_component(objects.components.types.BUFF_COMPONENT):
                ...
                if account is not None and session_id is None:
