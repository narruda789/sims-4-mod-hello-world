...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\celebrity_fans\fan_meet_and_greet_situation.py
# Compiled at: 2018-09-19 18:38:42
...
class FanMeetAndGreetSituation(SituationComplexCommon):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [(cls.celebrity.job, cls.celebrity.role_state),
         (
          cls.bartender.job, cls.bartender.role_state),
         (
          cls.fan.job, cls.fan.role_state)]
