...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\temple\temple_commands.py
# Compiled at: 2018-01-30 16:08:59
...
TEMPLE_NAME_LOOKUP = {181306:'Temple of Abundance', 
 181307:'Pristine Temple', 
 185848:'Temple of Death', 
 185849:'Digsite Temple', 
 185850:'Party Temple'}
...
def _get_jungle_open_street_director():
    ...
    if venue_service is None:
        ...
        if open_street_director is None:
            return
        return isinstance(open_street_director, JungleOpenStreetDirector) or None
...
def force_reset_temple(temple_id: int=None, _connection=None):
    ...
    if temple_id is not None:
        if temple_id == open_street_director.current_temple_id:
