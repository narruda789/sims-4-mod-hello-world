...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\skill_based_multi_interaction.py
# Compiled at: 2019-05-02 20:26:07
    ...
    def potential_interactions(cls, target, context, **kwargs):
        ...
        for skill_interaction in cls.skill_interactions:
            ...
            if skill_stat is None:
                continue
            if skill_interaction.object_criteria is not None:
                if not resolver(skill_interaction.object_criteria):
                    continue
