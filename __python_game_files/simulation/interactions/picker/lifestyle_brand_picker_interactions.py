...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\picker\lifestyle_brand_picker_interactions.py
# Compiled at: 2018-08-21 14:29:42
...
class LifestyleBrandProductsPicker(PickerSuperInteraction):
    ...
    def picker_rows_gen(cls, inst, target, context, **kwargs):
        ...
        for product in inst_or_cls.products:
            ...
            yield ObjectPickerRow(name=name, row_description=description, icon_info=IconInfoData(icon_resource=(product.icon.key)),
...
class LifestyleBrandTargetMarketPicker(PickerSuperInteraction):
    INSTANCE_TUNABLES = {'target_markets': TunableList(description='\n            A list of all the tuning needed for the different target markets for\n            the lifestyle brand Perk\n            ',
                         ...
                         invalid_enums=(
                        LifestyleBrandTargetMarket.INVALID,)),
    ...
    def picker_rows_gen(cls, inst, target, context, **kwargs):
        ...
        for target_market in inst_or_cls.target_markets:
            ...
            yield ObjectPickerRow(name=name, icon_info=IconInfoData(icon_resource=(target_market.icon.key)), tag=(target_market.target_type),
              is_selected=(selected_target_market == target_market.target_type))
