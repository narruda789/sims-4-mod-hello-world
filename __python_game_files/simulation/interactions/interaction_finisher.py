...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\interaction_finisher.py
# Compiled at: 2017-10-09 14:09:11
# Size of source mod 2**32: 9808 bytes
import enum, sims4.callback_utils
...
class InteractionFinisher:
    CANCELED = frozenset([FinishingType.USER_CANCEL,
     FinishingType.SI_FINISHED,
     ...
     FinishingType.WAIT_IN_LINE,
     FinishingType.OBJECT_CHANGED,
     FinishingType.SITUATIONS,
     FinishingType.CRAFTING,
     FinishingType.LIABILITY,
     FinishingType.DIALOG,
     FinishingType.CONDITIONAL_EXIT,
     FinishingType.FIRE,
     FinishingType.WEDDING,
     FinishingType.ROUTING_FORMATION])
