...
# Size of source mod 2**32: 92395 bytes
...
class SocialSuperInteraction(SocialInteractionMixin, SocialCompatibilityMixin, SuperInteraction):
 ...
 L. 808        16  LOAD_FAST                'participant_type'
 ...
 L. 820       102  LOAD_FAST                'inst'
          ...
          126_128  POP_JUMP_IF_TRUE    502  'to 502'
            130_0  COME_FROM           118  '118'
            130_1  COME_FROM           108  '108'

 L. 822       130  SETUP_LOOP          176  'to 176'
 ...
 L. 823       166  LOAD_FAST                'constraint'
              168  YIELD_VALUE      
              170  POP_TOP          
 ...
 L. 872       340  LOAD_CONST               None
              342  RETURN_VALUE     
            344_0  COME_FROM           336  '336'

 L. 874       344  LOAD_FAST                'initiator'
              346  LOAD_CONST               None
 ...
 L. 875       364  LOAD_GLOBAL              get_fallback_social_constraint_position
 ...
 L. 877       382  LOAD_CONST               None
              384  STORE_FAST               'fallback_position'
            386_0  COME_FROM           380  '380'

 L. 879       386  LOAD_FAST                'fallback_position'
              388  LOAD_CONST               None
              390  COMPARE_OP               is
          392_394  POP_JUMP_IF_FALSE   416  'to 416'

 L. 880       396  LOAD_FAST                'inst'
              398  LOAD_CONST               None
              400  COMPARE_OP               is-not
          402_404  POP_JUMP_IF_FALSE   412  'to 412'

 L. 884       406  LOAD_GLOBAL              GEOMETRY_INCOMPATIBLE_ANYWHERE
              408  YIELD_VALUE      
              410  POP_TOP          
            412_0  COME_FROM           402  '402'

 L. 885       412  LOAD_CONST               None
              414  RETURN_VALUE     
            416_0  COME_FROM           392  '392'

 L. 887       416  LOAD_FAST                'cls'
              418  LOAD_ATTR                _social_group_type
              420  LOAD_ATTR                make_constraint_default
              422  LOAD_FAST                'initiator'
              424  LOAD_FAST                'recipient'

 L. 888       426  LOAD_FAST                'fallback_position'

 L. 889       428  LOAD_FAST                'fallback_routing_surface'

 L. 890       430  LOAD_FAST                'relative_participant'

 L. 891       432  LOAD_FAST                'picked_object'

 L. 892       434  LOAD_FAST                'inst_or_cls'
              436  LOAD_ATTR                _social_group_participant_slot_overrides
              438  LOAD_CONST               ('participant_type', 'picked_object', 'participant_slot_overrides')
              440  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
              442  STORE_FAST               'fallback_constraint'

 L. 894       444  LOAD_FAST                'inst'
              446  LOAD_CONST               None
              448  COMPARE_OP               is-not
          450_452  POP_JUMP_IF_FALSE   460  'to 460'
              454  LOAD_FAST                'inst'
              456  LOAD_ATTR                priority
              458  JUMP_FORWARD        462  'to 462'
            460_0  COME_FROM           450  '450'
              460  LOAD_CONST               None
            462_0  COME_FROM           458  '458'
              462  STORE_FAST               'priority'

 L. 895       464  LOAD_FAST                'sim'
              466  LOAD_ATTR                si_state
              468  LOAD_ATTR                is_compatible_constraint
              470  LOAD_FAST                'fallback_constraint'
              472  LOAD_FAST                'priority'
              474  LOAD_FAST                'inst'
              476  LOAD_CONST               ('priority', 'to_exclude')
              478  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
          480_482  POP_JUMP_IF_FALSE   492  'to 492'

 L. 896       484  LOAD_FAST                'fallback_constraint'
              486  YIELD_VALUE      
              488  POP_TOP          
              490  JUMP_FORWARD        498  'to 498'
            492_0  COME_FROM           480  '480'

 L. 898       492  LOAD_GLOBAL              GEOMETRY_INCOMPATIBLE_ANYWHERE
              494  YIELD_VALUE      
              496  POP_TOP          
            498_0  COME_FROM           490  '490'

 L. 899       498  LOAD_CONST               None
              500  RETURN_VALUE     
            502_0  COME_FROM           126  '126'

 L. 901       502  LOAD_FAST                'participant_type'
              504  LOAD_GLOBAL              ParticipantType
              506  LOAD_ATTR                TargetSim
              508  COMPARE_OP               ==
          510_512  POP_JUMP_IF_FALSE   772  'to 772'

 L. 902       514  LOAD_FAST                'cls'
              516  LOAD_ATTR                acquire_targets_as_resource
          518_520  POP_JUMP_IF_TRUE    534  'to 534'

 L. 905       522  LOAD_GLOBAL              Anywhere
              524  CALL_FUNCTION_0       0  '0 positional arguments'
              526  YIELD_VALUE      
              528  POP_TOP          

 L. 906       530  LOAD_CONST               None
              532  RETURN_VALUE     
            534_0  COME_FROM           518  '518'

 L. 910       534  LOAD_FAST                'inst'
              536  LOAD_CONST               None
              538  COMPARE_OP               is-not
          540_542  POP_JUMP_IF_FALSE   656  'to 656'

 L. 911       544  LOAD_FAST                'inst'
              546  LOAD_METHOD              get_target_si
              548  CALL_METHOD_0         0  '0 positional arguments'
              550  UNPACK_SEQUENCE_2     2 
              552  STORE_FAST               'target_si'
              554  STORE_FAST               'test_result'

 L. 912       556  LOAD_FAST                'test_result'
          558_560  POP_JUMP_IF_TRUE    580  'to 580'

 L. 913       562  LOAD_GLOBAL              Nowhere
              564  LOAD_STR                 'SocialSuperInteraction._constraint_gen, target SI test failed({}) SI: {}'
              566  LOAD_FAST                'test_result'
              568  LOAD_FAST                'target_si'
              570  CALL_FUNCTION_3       3  '3 positional arguments'
              572  YIELD_VALUE      
              574  POP_TOP          

 L. 914       576  LOAD_CONST               None
              578  RETURN_VALUE     
            580_0  COME_FROM           558  '558'

 L. 916       580  LOAD_FAST                'target_si'
              582  LOAD_CONST               None
              584  COMPARE_OP               is-not
          586_588  POP_JUMP_IF_FALSE   656  'to 656'

 L. 917       590  LOAD_GLOBAL              issubclass
              592  LOAD_FAST                'target_si'
              594  LOAD_ATTR                affordance
              596  LOAD_GLOBAL              SocialPlaceholderSuperInteraction
              598  CALL_FUNCTION_2       2  '2 positional arguments'
          600_602  POP_JUMP_IF_TRUE    656  'to 656'

 L. 921       604  LOAD_FAST                'target_si'
              606  LOAD_METHOD              get_participant
              608  LOAD_GLOBAL              ParticipantType
              610  LOAD_ATTR                TargetSim
              612  CALL_METHOD_1         1  '1 positional argument'
              614  STORE_FAST               'target_si_target'

 L. 922       616  SETUP_LOOP          652  'to 652'
              618  LOAD_FAST                'target_si'
              620  LOAD_ATTR                constraint_gen
              622  LOAD_FAST                'sim'
              624  LOAD_FAST                'target_si_target'
              626  LOAD_GLOBAL              ParticipantType
              628  LOAD_ATTR                Actor
              630  LOAD_CONST               ('participant_type',)
              632  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
              634  GET_ITER         
              636  FOR_ITER            650  'to 650'
              638  STORE_FAST               'constraint'

 L. 923       640  LOAD_FAST                'constraint'
              642  YIELD_VALUE      
              644  POP_TOP          
          646_648  JUMP_BACK           636  'to 636'
              650  POP_BLOCK        
            652_0  COME_FROM_LOOP      616  '616'

 L. 924       652  LOAD_CONST               None
              654  RETURN_VALUE     
            656_0  COME_FROM           600  '600'
            656_1  COME_FROM           586  '586'
            656_2  COME_FROM           540  '540'

 L. 926       656  SETUP_LOOP          704  'to 704'
              658  LOAD_GLOBAL              super
              660  LOAD_GLOBAL              SuperInteraction
              662  LOAD_FAST                'cls'
              664  CALL_FUNCTION_2       2  '2 positional arguments'
              666  LOAD_ATTR                _constraint_gen
              668  LOAD_FAST                'sim'
              670  LOAD_FAST                'target'
              672  BUILD_TUPLE_2         2 
              674  LOAD_STR                 'participant_type'
              676  LOAD_FAST                'participant_type'
              678  BUILD_MAP_1           1 
              680  LOAD_FAST                'kwargs'
              682  BUILD_MAP_UNPACK_WITH_CALL_2     2 
              684  CALL_FUNCTION_EX_KW     1  'keyword and positional arguments'
              686  GET_ITER         
              688  FOR_ITER            702  'to 702'
              690  STORE_FAST               'constraint'

 L. 927       692  LOAD_FAST                'constraint'
              694  YIELD_VALUE      
              696  POP_TOP          
          698_700  JUMP_BACK           688  'to 688'
              702  POP_BLOCK        
            704_0  COME_FROM_LOOP      656  '656'

 L. 929       704  LOAD_FAST                'inst'
              706  LOAD_CONST               None
              708  COMPARE_OP               is-not
          710_712  POP_JUMP_IF_FALSE   880  'to 880'

 L. 930       714  LOAD_FAST                'inst'
              716  LOAD_ATTR                social_group
              718  LOAD_CONST               None
              720  COMPARE_OP               is-not
          722_724  POP_JUMP_IF_FALSE   742  'to 742'

 L. 931       726  LOAD_FAST                'inst'
              728  LOAD_ATTR                social_group
              730  LOAD_METHOD              get_constraint
              732  LOAD_FAST                'sim'
              734  CALL_METHOD_1         1  '1 positional argument'
              736  YIELD_VALUE      
              738  POP_TOP          
              740  JUMP_FORWARD        770  'to 770'
            742_0  COME_FROM           722  '722'

 L. 933       742  LOAD_GLOBAL              logger
              744  LOAD_ATTR                error
              746  LOAD_STR                 'Attempt to get constraint from Social interaction and no constraint exists: {}'

 L. 934       748  LOAD_FAST                'inst'
              750  LOAD_STR                 'maxr'
              752  LOAD_CONST               ('owner',)
              754  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
              756  POP_TOP          

 L. 935       758  LOAD_GLOBAL              Anywhere
              760  CALL_FUNCTION_0       0  '0 positional arguments'
              762  YIELD_VALUE      
              764  POP_TOP          

 L. 936       766  LOAD_CONST               None
              768  RETURN_VALUE     
            770_0  COME_FROM           740  '740'
              770  JUMP_FORWARD        880  'to 880'
            772_0  COME_FROM           510  '510'

 L. 938       772  LOAD_FAST                'participant_type'
              774  LOAD_GLOBAL              ParticipantType
              776  LOAD_ATTR                Actor
              778  COMPARE_OP               ==
          780_782  POP_JUMP_IF_FALSE   880  'to 880'

 L. 939       784  SETUP_LOOP          832  'to 832'
              786  LOAD_GLOBAL              super
              788  LOAD_GLOBAL              SuperInteraction
              790  LOAD_FAST                'inst_or_cls'
              792  CALL_FUNCTION_2       2  '2 positional arguments'
              794  LOAD_ATTR                _constraint_gen
              796  LOAD_FAST                'sim'
              798  LOAD_FAST                'target'
              800  BUILD_TUPLE_2         2 
              802  LOAD_STR                 'participant_type'
              804  LOAD_FAST                'participant_type'
              806  BUILD_MAP_1           1 
              808  LOAD_FAST                'kwargs'
              810  BUILD_MAP_UNPACK_WITH_CALL_2     2 
              812  CALL_FUNCTION_EX_KW     1  'keyword and positional arguments'
              814  GET_ITER         
              816  FOR_ITER            830  'to 830'
              818  STORE_FAST               'constraint'

 L. 940       820  LOAD_FAST                'constraint'
              822  YIELD_VALUE      
              824  POP_TOP          
          826_828  JUMP_BACK           816  'to 816'
              830  POP_BLOCK        
            832_0  COME_FROM_LOOP      784  '784'

 L. 941       832  LOAD_FAST                'inst'
              834  LOAD_CONST               None
              836  COMPARE_OP               is-not
          838_840  POP_JUMP_IF_FALSE   880  'to 880'

 L. 942       842  LOAD_FAST                'inst'
              844  LOAD_ATTR                social_group
              846  LOAD_CONST               None
              848  COMPARE_OP               is-not
          850_852  POP_JUMP_IF_FALSE   880  'to 880'
              854  LOAD_FAST                'participant_type'
              856  LOAD_GLOBAL              ParticipantType
              858  LOAD_ATTR                Actor
              860  COMPARE_OP               ==
          862_864  POP_JUMP_IF_FALSE   880  'to 880'

 L. 943       866  LOAD_FAST                'inst'
              868  LOAD_ATTR                social_group
              870  LOAD_METHOD              get_constraint
              872  LOAD_FAST                'sim'
            ...
            880_2  COME_FROM           838  '838'
            880_3  COME_FROM           780  '780'
            880_4  COME_FROM           770  '770'
            880_5  COME_FROM           710  '710'

Parse error at or near `COME_FROM' instruction at offset 880_4
