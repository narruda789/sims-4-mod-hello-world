...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\payment\payment_dest.py
# Compiled at: 2020-04-16 23:44:19
    ...
    def get_funds_info(self, resolver):
        ...
        if stat is not None:
            ...
            if self.is_debt is not None:
                return (
                 value, value, int(self.is_debt * value))
            return (
             stat.max_value - value, value, None)
        return (None, 0, None)