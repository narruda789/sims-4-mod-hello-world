...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\google\protobuf\internal\cpp_message.py
# Compiled at: 2013-10-04 12:43:25
# Size of source mod 2**32: 26592 bytes
__author__ = 'petar@google.com (Petar Petrov)'
import operator, _net_proto2___python
...
class RepeatedScalarContainer(object):
    __slots__ = [
     '_message', '_cfield_descriptor', '_cmsg']
...
class RepeatedCompositeContainer(object):
    __slots__ = [
     '_message', '_subclass', '_cfield_descriptor', '_cmsg']
...
def _AddInitMethod(message_descriptor, cls):
    ...
    def Init(self, **kwargs):
        ...
        if owner is not None:
            self._owner = owner
        elif message_descriptor.is_extendable:
...
def _AddMessageMethods(message_descriptor, cls):
    ...
    def ClearField(self, field_name_in_char):
        ...
        elif child_cmessage is not None:
    ...
    def __eq__(self, other):
        if self is other:
            ...
            return isinstance(other, self.__class__) or False
