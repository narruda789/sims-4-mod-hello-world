...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\sims4\gsi\dispatcher.py
# Compiled at: 2016-09-09 12:35:50
# Size of source mod 2**32: 10337 bytes
import inspect, json
from sims4.gsi.schema import GsiSchema, LATEST_GSI_SERVER_VERSION, CLIENT_GSI_BASE_VERSION
from sims4.log import LEVEL_WARN
import sims4.log, sims4.reload, sims4.zone_utils
...
def get_all_gsi_schema_names():
    ...
    return (
     normal_schemas, archive_schemas)
        ...
        def _invoke_handler(**kwargs):
            if full_arg_spec.varkw:
                ...
                for key, value in kwargs.items():
                    if key in full_arg_spec.args or key in full_arg_spec.kwonlyargs:
        ...
        if query:
            if 'zone_id' in query:
                ...
                if zone_manager is not None:
                    if zone_manager.get(zone_id) is None:
                        return
