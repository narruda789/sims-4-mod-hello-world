...
# Embedded file name: T:\InGame\Gameplay\Scripts\Core\sims4\tuning\instances.py
# Compiled at: 2019-06-05 18:53:50
# Size of source mod 2**32: 13372 bytes
import sims4.hash_util, sims4.log
...
class TunedInstanceMetaclass(type):
    ...
    def get_removed_tunable_names(cls):
        ...
        for base_cls in cls.get_parents():
            cls_vars = vars(base_cls)
            if isinstance(base_cls, TunedInstanceMetaclass):
