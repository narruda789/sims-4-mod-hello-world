...
# Size of source mod 2**32: 41828 bytes
from _resourceman import *
import _resourceman, io, os, protocolbuffers
from caches import cached
import enum, sims4.callback_utils, sims4.hash_util, sims4.log
...
class Types(enum.Int, export=False):
    ...
    DECOTRIM = 332336850
    LOCATOR = 1220708729
    TUNING = _add_inst_tuning('tuning', type_name_plural='tuning',
      file_extension='tun',
      resource_type=62078431,
      manager_name='module_tuning_manager')
    SNIPPET = _add_inst_tuning('snippet', resource_type=2113017500,
      require_reference=True)
    POSTURE = _add_inst_tuning('posture', resource_type=2909789983)
    SLOT_TYPE = _add_inst_tuning('slot_type', resource_type=1772477092,
      use_guid_for_ref=False,
      base_game_only=True,
      require_reference=True)
    STATIC_COMMODITY = _add_inst_tuning('static_commodity', type_name_plural='static_commodities',
      file_extension='scommodity',
      resource_type=1359443523,
      require_reference=True)
    RELATIONSHIP_BIT = _add_inst_tuning('relationship_bit', file_extension='relbit',
      resource_type=151314192,
      require_reference=True)
    ...
    SLOT_TYPE_SET = _add_inst_tuning('slot_type_set', resource_type=1058419973,
      use_guid_for_ref=False,
      base_game_only=True)
    PIE_MENU_CATEGORY = _add_inst_tuning('pie_menu_category', type_name_plural='pie_menu_categories',
      resource_type=65657188,
      require_reference=True)
    ASPIRATION = _add_inst_tuning('aspiration', resource_type=683034229)
    ASPIRATION_CATEGORY = _add_inst_tuning('aspiration_category', type_name_plural='aspiration_categories',
      resource_type=3813727192,
      require_reference=True)
    ...
    INTERACTION = _add_inst_tuning('interaction', resource_type=3900887599,
      manager_name='affordance_manager',
      require_reference=True)
    ACHIEVEMENT = _add_inst_tuning('achievement', resource_type=2018877086)
    ACHIEVEMENT_CATEGORY = _add_inst_tuning('achievement_category', type_name_plural='achievement_categories',
      resource_type=609337601,
      require_reference=True)
    ...
    LOT_TUNING = _add_inst_tuning('lot_tuning', resource_type=3632270694,
      require_reference=True)
    REGION = _add_inst_tuning('region', resource_type=1374134669,
      require_reference=True)
    STREET = _add_inst_tuning('street', resource_type=4142189312,
      require_reference=True)
    WALK_BY = _add_inst_tuning('walk_by', resource_type=1070998590,
      require_reference=True)
    OBJECT = _add_inst_tuning('object', manager_name='definition_manager',
      resource_type=3055412916,
      require_reference=True)
    ...
    SUBROOT = _add_inst_tuning('subroot', resource_type=3086978965,
      require_reference=True)
    SOCIAL_GROUP = _add_inst_tuning('social_group', manager_name='social_group_tuning_manager',
      resource_type=776446212,
      require_reference=True)
    ...
    TEMPLATE_CHOOSER = _add_inst_tuning('template_chooser', resource_type=1220728301,
      require_reference=True)
    ZONE_DIRECTOR = _add_inst_tuning('zone_director', resource_type=4183335058,
      require_reference=True)
    ...
    CAREER_TRACK = _add_inst_tuning('career_track', resource_type=1221024995,
      require_reference=True)
    CAREER_EVENT = _add_inst_tuning('career_event', resource_type=2487354146,
      require_reference=True)
    ...
    CLUB_SEED = _add_inst_tuning('club_seed', resource_type=794407991,
      require_reference=True)
    CLUB_INTERACTION_GROUP = _add_inst_tuning('club_interaction_group', resource_type=4195351092)
    DRAMA_NODE = _add_inst_tuning('drama_node', resource_type=626258997)
    ENSEMBLE = _add_inst_tuning('ensemble', resource_type=3112702240,
      require_reference=True)
    BUSINESS = _add_inst_tuning('business', type_name_plural='businesses',
      resource_type=1977092083,
      require_reference=True)
    OPEN_STREET_DIRECTOR = _add_inst_tuning('open_street_director', resource_type=1265622724,
      require_reference=True)
    ...
    CALL_TO_ACTION = _add_inst_tuning('call_to_action', type_name_plural='calls_to_action',
      resource_type=4114068192)
    SICKNESS = _add_inst_tuning('sickness', type_name_plural='sicknesses',
      resource_type=3288062174)
    ...
    CONDITIONAL_LAYER = _add_inst_tuning('conditional_layer', resource_type=2441338001,
      require_reference=True)
    SEASON = _add_inst_tuning('season', resource_type=3381515358,
      require_reference=True)
    HOLIDAY_DEFINITION = _add_inst_tuning('holiday_definition', resource_type=238120813,
      require_reference=True)
    HOLIDAY_TRADITION = _add_inst_tuning('holiday_tradition', resource_type=1070408838)
    WEATHER_EVENT = _add_inst_tuning('weather_event', resource_type=1476851130,
      require_reference=True)
    WEATHER_FORECAST = _add_inst_tuning('weather_forecast', resource_type=1233072753,
      require_reference=True)
    ...
    HEADLINE = _add_inst_tuning('headline', resource_type=4093714525,
      require_reference=True)
    RABBIT_HOLE = _add_inst_tuning('rabbit_hole', resource_type=2976568058,
      require_reference=True)
    NARRATIVE = _add_inst_tuning('narrative', resource_type=1047870521,
      require_reference=True)
    SPELL = _add_inst_tuning('spell', resource_type=523506649,
      require_reference=True)
    CAS_STORIES_QUESTION = _add_inst_tuning('cas_stories_question', resource_type=52718493)
    CAS_STORIES_ANSWER = _add_inst_tuning('cas_stories_answer', resource_type=2163289367,
      require_reference=True)
    CAS_STORIES_TRAIT_CHOOSER = _add_inst_tuning('cas_stories_trait_chooser', resource_type=2376930633,
      require_reference=True)
    UNIVERSITY_COURSE_DATA = _add_inst_tuning('university_course_data', resource_type=689745854,
      require_reference=True)
    UNIVERSITY_MAJOR = _add_inst_tuning('university_major', resource_type=660124491,
      require_reference=True)
    UNIVERSITY = _add_inst_tuning('university', type_name_plural='universities',
      resource_type=3646477745,
      require_reference=True)
    ...
    CAS_PREFERENCE_ITEM = _add_inst_tuning('cas_preference_item', resource_type=3966303522,
      require_reference=True)
    STORY_ARC = _add_inst_tuning('story_arc', resource_type=1613438381,
      require_reference=True)
    STORY_CHAPTER = _add_inst_tuning('story_chapter', resource_type=1250314810,
      require_reference=True)
    LUNAR_CYCLE = _add_inst_tuning('lunar_cycle', type_name_plural='lunar_cycle',
      resource_type=1430862616,
      require_reference=True)
    WHIM = _add_inst_tuning('whim', resource_type=1956251190,
      require_reference=True)
    CLAN = _add_inst_tuning('clan', resource_type=3737052837)
    CLAN_VALUE = _add_inst_tuning('clan_value', resource_type=2576273579,
      require_reference=True)
