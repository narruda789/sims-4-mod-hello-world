...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\re.py
# Compiled at: 2018-07-31 18:42:56
# Size of source mod 2**32: 15570 bytes
import enum_lib as enum, sre_compile, sre_parse, functools
try:
    import _locale
except ImportError:
    _locale = None
...
def _compile(pattern, flags):
    if isinstance(flags, RegexFlag):
        ...
        if isinstance(pattern, Pattern):
            ...
            return pattern
        assert sre_compile.isstring(pattern), 'first argument must be string or compiled pattern'
