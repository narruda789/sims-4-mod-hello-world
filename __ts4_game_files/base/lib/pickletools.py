...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\pickletools.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 94070 bytes
import codecs, io, pickle, re, sys
__all__ = [
 'dis', 'genops', 'optimize']
...
uint1 = ArgumentDescriptor(name='uint1',
  n=1,
  reader=read_uint1,
...
uint2 = ArgumentDescriptor(name='uint2',
  n=2,
  reader=read_uint2,
...
int4 = ArgumentDescriptor(name='int4',
  n=4,
  reader=read_int4,
...
uint4 = ArgumentDescriptor(name='uint4',
  n=4,
  reader=read_uint4,
...
uint8 = ArgumentDescriptor(name='uint8',
  n=8,
  reader=read_uint8,
...
stringnl = ArgumentDescriptor(name='stringnl',
  n=UP_TO_NEWLINE,
...
stringnl_noescape = ArgumentDescriptor(name='stringnl_noescape',
  n=UP_TO_NEWLINE,
...
stringnl_noescape_pair = ArgumentDescriptor(name='stringnl_noescape_pair',
  n=UP_TO_NEWLINE,
...
string1 = ArgumentDescriptor(name='string1',
...
string4 = ArgumentDescriptor(name='string4',
...
bytes1 = ArgumentDescriptor(name='bytes1',
  n=TAKEN_FROM_ARGUMENT1,
  reader=read_bytes1,
...
bytes4 = ArgumentDescriptor(name='bytes4',
...
bytes8 = ArgumentDescriptor(name='bytes8',
...
def read_unicodestring1(f):
    ...
    raise ValueError('expected %d bytes in a unicodestring1, but only %d remain' % (
     n, len(data)))


unicodestring1 = ArgumentDescriptor(name='unicodestring1',
  n=TAKEN_FROM_ARGUMENT1,
...
unicodestring4 = ArgumentDescriptor(name='unicodestring4',
  n=TAKEN_FROM_ARGUMENT4U,
...
def read_unicodestring8(f):
    ...
    if len(data) == n:
        return str(data, 'utf-8', 'surrogatepass')
    raise ValueError('expected %d bytes in a unicodestring8, but only %d remain' % (
     n, len(data)))


unicodestring8 = ArgumentDescriptor(name='unicodestring8',
  n=TAKEN_FROM_ARGUMENT8U,
...
decimalnl_long = ArgumentDescriptor(name='decimalnl_long',
  n=UP_TO_NEWLINE,
...
floatnl = ArgumentDescriptor(name='floatnl',
  n=UP_TO_NEWLINE,
  reader=read_floatnl,
...
float8 = ArgumentDescriptor(name='float8',
  n=8,
  reader=read_float8,
...
long1 = ArgumentDescriptor(name='long1',
  n=TAKEN_FROM_ARGUMENT1,
  reader=read_long1,
...
long4 = ArgumentDescriptor(name='long4',
  n=TAKEN_FROM_ARGUMENT4,
  reader=read_long4,
...
pyint = pylong = StackObject(name='int',
  obtype=int,
  doc='A Python integer object.')
pyinteger_or_bool = StackObject(name='int_or_bool',
  obtype=(
 int, bool),
  doc='A Python integer or boolean object.')
pybool = StackObject(name='bool',
  obtype=bool,
  doc='A Python boolean object.')
pyfloat = StackObject(name='float',
  obtype=float,
  doc='A Python float object.')
pybytes_or_str = pystring = StackObject(name='bytes_or_str',
  obtype=(
 bytes, str),
  doc='A Python bytes or (Unicode) string object.')
pybytes = StackObject(name='bytes',
  obtype=bytes,
  doc='A Python bytes object.')
pyunicode = StackObject(name='str',
  obtype=str,
  doc='A Python (Unicode) string object.')
pynone = StackObject(name='None',
  obtype=(type(None)),
  doc='The Python None object.')
pytuple = StackObject(name='tuple',
  obtype=tuple,
  doc='A Python tuple object.')
pylist = StackObject(name='list',
  obtype=list,
  doc='A Python list object.')
pydict = StackObject(name='dict',
  obtype=dict,
  doc='A Python dict object.')
pyset = StackObject(name='set',
  obtype=set,
  doc='A Python set object.')
pyfrozenset = StackObject(name='frozenset',
  obtype=set,
  doc='A Python frozenset object.')
anyobject = StackObject(name='any',
  obtype=object,
  doc='Any kind of object whatsoever.')
markobject = StackObject(name='mark',
  obtype=StackObject,
  doc="'The mark' is a unique object.\n\nOpcodes that operate on a variable number of objects\ngenerally don't embed the count of objects in the opcode,\nor pull it off the stack.  Instead the MARK opcode is used\nto push a special marker object on the stack, and then\nsome other opcodes grab all the objects from the top of\nthe stack down to (but not including) the topmost marker\nobject.\n")
stackslice = StackObject(name='stackslice',
  obtype=StackObject,
...
opcodes = [
 ...
 I(name='SHORT_BINUNICODE', code='\x8c',
   arg=unicodestring1,
   stack_before=[],
   stack_after=[
  pyunicode],
 ...
 I(name='APPENDS', code='e',
   arg=None,
   stack_before=[
  pylist, markobject, stackslice],
   stack_after=[
  pylist],
   proto=1,
 ...
 I(name='SETITEM', code='s',
   arg=None,
   stack_before=[
  pydict, anyobject, anyobject],
   stack_after=[
  pydict],
   proto=0,
   doc='Add a key+value pair to an existing dict.\n\n      Stack before:  ... pydict key value\n      Stack after:   ... pydict\n\n      where pydict has been modified via pydict[key] = value.\n      '),
 I(name='SETITEMS', code='u',
   arg=None,
   stack_before=[
  pydict, markobject, stackslice],
   stack_after=[
  pydict],
   proto=1,
   doc='Add an arbitrary number of key+value pairs to an existing dict.\n\n      The slice of the stack following the topmost markobject is taken as\n      an alternating sequence of keys and values, added to the dict\n      immediately under the topmost markobject.  Everything at and after the\n      topmost markobject is popped, leaving the mutated dict at the top\n      of the stack.\n\n      Stack before:  ... pydict markobject key_1 value_1 ... key_n value_n\n      Stack after:   ... pydict\n\n      where pydict has been modified via pydict[key_i] = value_i for i in\n      1, 2, ..., n, and in that order.\n      '),
 I(name='EMPTY_SET', code='\x8f',
   arg=None,
   stack_before=[],
   stack_after=[
  pyset],
 ...
 I(name='ADDITEMS', code='\x90',
   arg=None,
   stack_before=[
  pyset, markobject, stackslice],
   stack_after=[
  pyset],
   proto=4,
 ...
 I(name='BINPUT', code='q',
   arg=uint1,
   stack_before=[],
   stack_after=[],
   proto=1,
   doc='Store the stack top into the memo.  The stack is not popped.\n\n      The index of the memo location to write into is given by the 1-byte\n      unsigned integer following.\n      '),
 I(name='LONG_BINPUT', code='r',
   arg=uint4,
   stack_before=[],
   stack_after=[],
   proto=1,
   doc='Store the stack top into the memo.  The stack is not popped.\n\n      The index of the memo location to write into is given by the 4-byte\n      unsigned little-endian integer following.\n      '),
 I(name='MEMOIZE', code='\x94',
   arg=None,
   stack_before=[
  anyobject],
   stack_after=[
 ...
 I(name='OBJ', code='o',
   arg=None,
   stack_before=[
  markobject, anyobject, stackslice],
   stack_after=[
  anyobject],
   proto=1,
...
def dis(pickle, out=None, memo=None, indentlevel=4, annotate=0):
    ...
    for opcode, arg, pos in genops(pickle):
        if pos is not None:
            ...
            numtopop = len(before)
            markmsg = None
            if (markobject in before or opcode.name) == 'POP' and stack:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o',
      '--output', default=(sys.stdout), type=(argparse.FileType('w')), help='the file where the output should be written')
    parser.add_argument('-m',
      '--memo', action='store_true', help='preserve memo between disassemblies')
    parser.add_argument('-l',
      '--indentlevel', default=4, type=int, help='the number of blanks by which to indent a new MARK level')
    parser.add_argument('-a',
      '--annotate', action='store_true', help='annotate each line with a short opcode description')
    parser.add_argument('-p',
      '--preamble', default='==> {name} <==', help='if more than one pickle file is specified, print this before each disassembly')
