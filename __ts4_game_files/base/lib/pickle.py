...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\pickle.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 59484 bytes
        ...
        if reduce is not None:
            ...
            if issc:
                ...
                if isinstance(rv, str):
                    ...
                    return
                assert isinstance(rv, tuple), '%s must return string or tuple' % reduce
            l = len(rv)
            if not 2 <= l <= 5:
