...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\_markupbase.py
# Compiled at: 2013-04-05 19:16:38
...
class ParserBase:
                    ...
                    if c in self._decl_otherchars:
                        ...
                        if c == '[':
                            if decltype == 'doctype':
                                ...
                                if decltype in frozenset({'linktype', 'element', 'attlist', 'link'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            ...
            if sectName in frozenset({'temp', 'ignore', 'include', 'rcdata', 'cdata'}):
                match = _markedsectionclose.search(rawdata, i + 3)
            else:
                if sectName in frozenset({'if', 'else', 'endif'}):
    ...
    def _parse_doctype_subset(self, i, declstartpos):
        ...
        while j < n:
            ...
            if c == '<':
                ...
                if j == -1:
                    return -1
                    if name not in frozenset({'notation', 'attlist', 'element', 'entity'}):
