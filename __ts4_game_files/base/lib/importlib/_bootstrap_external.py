...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\importlib\_bootstrap_external.py
# Compiled at: 2018-08-07 19:10:42
# Size of source mod 2**32: 60809 bytes
...
def _validate_timestamp_pyc(data, source_mtime, source_size, name, exc_details):
    ...
    if source_size is not None:
        if _r_long(data[12:16]) != source_size & 4294967295:
                ...
                try:
                    ...
                    try:
                        ...
                        if hash_based:
                            ...
                            if not _imp.check_hash_based_pycs != 'never' or check_source or _imp.check_hash_based_pycs == 'always':
                    ...
                    if not sys.dont_write_bytecode:
                        if bytecode_path is not None and source_mtime is not None:
                            if hash_based:
