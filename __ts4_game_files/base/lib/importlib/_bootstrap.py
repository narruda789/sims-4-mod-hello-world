...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\importlib\_bootstrap.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 40442 bytes
...
def _exec(spec, module):
    ...
    with _ModuleLockManager(name):
        if sys.modules.get(name) is not module:
            ...
            return module
            _init_module_attrs(spec, module, override=True)
            hasattr(spec.loader, 'exec_module') or spec.loader.load_module(name)
        else:
