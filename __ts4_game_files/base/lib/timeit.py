...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\timeit.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 13818 bytes
...
def main(args=None, *, _wrap_timer=None):
    if args is None:
        ...
        if number == 0:
            ...
            if verbose:
                ...
                def callback(number, time_taken):
                    ...
                    plural = number != 1
                    print(msg.format(num=number, s=('s' if plural else ''), secs=time_taken,
                      prec=precision))
        ...
        try:
            ...
            if worst >= best * 4:
                import warnings
                warnings.warn_explicit('The test results are likely unreliable. The worst time (%s) was more than four times slower than the best time (%s).' % (
