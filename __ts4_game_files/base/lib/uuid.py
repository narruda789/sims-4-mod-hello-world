...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\uuid.py
# Compiled at: 2018-07-31 18:42:56
# Size of source mod 2**32: 29554 bytes
import os, sys
    ...
    def variant(self):
        if not self.int & 9223372036854775808:
            ...
            if not self.int & 4611686018427387904:
                return RFC_4122
            return self.int & 2305843009213693952 or RESERVED_MICROSOFT
...
def _load_system_functions():
    ...
    global _has_uuid_generate_time_safe
...
_NODE_GETTERS_UNIX = [
 _unix_getnode, _ifconfig_getnode, _ip_getnode,
