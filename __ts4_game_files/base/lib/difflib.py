...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\difflib.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 86484 bytes
__all__ = [
...
class SequenceMatcher:
    ...
    def find_longest_match(self, alo, ahi, blo, bhi):
        ...
        while besti > alo and bestj > blo and not isbjunk(b[(bestj - 1)]):
            if a[(besti - 1)] == b[(bestj - 1)]:
                besti, bestj, bestsize = besti - 1, bestj - 1, bestsize + 1

        while besti + bestsize < ahi and bestj + bestsize < bhi and not isbjunk(b[(bestj + bestsize)]):
    ...
    def get_grouped_opcodes(self, n=3):
        ...
        if group:
            len(group) == 1 and group[0][0] == 'equal' or (yield group)
