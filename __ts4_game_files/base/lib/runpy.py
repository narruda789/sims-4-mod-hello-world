...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\runpy.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 12253 bytes
import sys, importlib.machinery, importlib.util, types
...
def run_path(path_name, init_globals=None, run_name=None):
    ...
    if isinstance(importer, type(None)) or is_NullImporter:
        ...
        return _run_module_code(code, init_globals, run_name, pkg_name=pkg_name,
          script_name=fname)
