...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\urllib\parse.py
...
class _NetlocResultMixinStr(_NetlocResultMixinBase, _ResultMixinStr):
    ...
    def _userinfo(self):
        ...
        if have_info:
            ...
            password = have_password or None
        else:
...
def urljoin(base, url, allow_fragments=True):
    ...
    return _coerce_result(urlunparse((scheme, netloc,
     '/'.join(resolved_path) or '/', params, query, fragment)))
