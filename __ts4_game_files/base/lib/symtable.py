...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\symtable.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 7512 bytes
import _symtable
from _symtable import USE, DEF_GLOBAL, DEF_LOCAL, DEF_PARAM, DEF_IMPORT, DEF_BOUND, DEF_ANNOT, SCOPE_OFF, SCOPE_MASK, FREE, LOCAL, GLOBAL_IMPLICIT, GLOBAL_EXPLICIT, CELL
import weakref
__all__ = [
...
class Symbol(object):
    ...
    def is_annotated(self):
        return bool(self._Symbol__flags & DEF_ANNOT)
