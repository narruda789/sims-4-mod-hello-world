...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\fileinput.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 14995 bytes
import sys, os
__all__ = [
...
class FileInput:
    ...
    def __init__(self, files=None, inplace=False, backup='', bufsize=0, mode='r', openhook=None):
        ...
        if bufsize:
            import warnings
            warnings.warn('bufsize is deprecated and ignored', DeprecationWarning,
              stacklevel=2)
