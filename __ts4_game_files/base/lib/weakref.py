...
# Embedded file name: T:\InGame\Gameplay\Scripts\Lib\weakref.py
# Compiled at: 2018-06-26 23:07:36
# Size of source mod 2**32: 21113 bytes
...
class WeakMethod(ref):
    ...
    def __eq__(self, other):
        if isinstance(other, WeakMethod):
            return self._alive and other._alive or self is other
            return ref.__eq__(self, other) and self._func_ref == other._func_ref
        return False

    def __ne__(self, other):
        if isinstance(other, WeakMethod):
            return self._alive and other._alive or self is not other
