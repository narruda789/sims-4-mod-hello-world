...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\carry\carrying_component.py
# Compiled at: 2016-10-05 20:10:40
# Size of source mod 2**32: 10493 bytes
...
class CarryingComponent(Component, HasTunableFactory, AutoFactoryInit, component_name=types.CARRYING_COMPONENT):
    ...
    FACTORY_TUNABLES = {'carry_locomotion':TunableVariant(description='\n            Define how this Sim locomotes, and by that how this Sim holds\n            things.\n            ',
     ...
     'holstering_behavior':TunableTuple(description='\n            Define the holstering behavior for this Sim.\n            ',
       ...
       tunable_type=Age,
       default=(Age.ADULT)),
       value_type=(TunableHolsteringBehaviorVariant())))}
