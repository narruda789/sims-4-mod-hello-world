...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\performance\gc_commands.py
# Compiled at: 2018-08-21 22:18:59
# Size of source mod 2**32: 13164 bytes
import gc, math
from date_and_time import TimeSpan, TICKS_PER_REAL_WORLD_SECOND, create_time_span
from sims4.commands import CommandType
from sims4.utils import create_csv
import alarms, services, sims4.commands, zone
...
def object_count_log_callback(phase, info):
    global gc_inc_window_collected
    global gc_inc_window_current
    global gc_inc_window_size
