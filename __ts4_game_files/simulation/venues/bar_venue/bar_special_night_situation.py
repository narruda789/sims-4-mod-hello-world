...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\venues\bar_venue\bar_special_night_situation.py
# Compiled at: 2017-11-28 14:31:11
# Size of source mod 2**32: 5361 bytes
...
class BarSpecialNightSituation(SituationComplexCommon):
    ...
    def _issue_requests(self):
        request = BouncerRequestFactory(self, callback_data=_RequestUserData(role_state_type=(self.special_night_patron.role_state)),
          job_type=(self.special_night_patron.job),
...
lock_instance_tunables(BarSpecialNightSituation, exclusivity=(BouncerExclusivityCategory.VENUE_BACKGROUND),
