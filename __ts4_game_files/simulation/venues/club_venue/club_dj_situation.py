...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\venues\club_venue\club_dj_situation.py
...
lock_instance_tunables(DJSituation, exclusivity=(BouncerExclusivityCategory.VENUE_EMPLOYEE),
