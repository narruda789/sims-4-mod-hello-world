...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\venues\cafe_venue\cafe_media_addict_situation.py
# Compiled at: 2016-08-29 17:13:06
...
class CafeMediaAddictSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (SituationStateData(1, _PreOrderCoffeeState, factory=(cls.pre_order_coffee_state)),
         ...
         SituationStateData(3, _MediaAddictState, factory=(cls.media_addict_state)))
    ...
    def sim_of_interest(self, sim_info):
        if self._media_addict is not None:
            if self._media_addict.sim_info is sim_info:
                return True
        return False
...
lock_instance_tunables(CafeMediaAddictSituation, exclusivity=(BouncerExclusivityCategory.NORMAL),
