...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\holidays\holiday_tracker.py
# Compiled at: 2022-02-09 13:21:47
# Size of source mod 2**32: 20747 bytes
...
class HolidayTracker:
    ...
    def is_holiday_cancelled(self, holiday_id):
        if holiday_id == self._cancelled_holiday:
    ...
    def get_active_holiday_business_price_multiplier(self, business_type):
        ...
        for tradition in self.get_active_traditions():
            base_multiplier *= tradition.get_business_multiplier(business_type)
    ...
    def on_holiday_modified(self, holiday_id, added_traditions, removed_traditions, ordered_traditions, theme_updated):
        if self._pre_day_holiday_id == holiday_id:
            ...
            if self._active_holiday_id == holiday_id:
                if removed_traditions:
        ...
        if theme_updated:
            if self.get_active_or_upcoming_holiday() == holiday_id:
