...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\portals\portal_data_elevator.py
# Compiled at: 2018-04-23 21:16:56
...
class _PortalTypeDataElevator(_PortalTypeDataBase):
    ...
    def get_portal_locations(self, obj):
        ...
        return (
         (
          shell_loc, elevator_loc, elevator_loc, shell_loc, 0),)

    def is_ungreeted_sim_disallowed(self):
        zone_id = services.current_zone_id()
        active_household = services.active_household()
        if active_household is not None:
            if active_household.home_zone_id == zone_id:
                return False
