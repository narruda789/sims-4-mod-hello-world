...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\routing\path_planner\height_clearance_helper.py
# Compiled at: 2020-07-31 21:08:32
...
def get_required_height_clearance(height_clearance_target, override_tuning=None):
    if hasattr(height_clearance_target, 'routing_component'):
        if height_clearance_target.has_component(ROUTING_COMPONENT):
