...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\tunable_utils\tunable_model.py
# Compiled at: 2019-05-31 20:40:03
...
class TunableModel(TunableSingletonFactory):
    ...
    def __init__(self, **kwargs):
        (super().__init__)(model=TunableVariant(description='\n                Define the model to use.\n                ',
                  from_resource=(TunableModel._ModelFromResource.TunableFactory()),
                  from_definition=(TunableModel._ModelFromDefinition.TunableFactory()),
                  default='from_resource'), **kwargs)


class TunableModelOrDefault(OptionalTunable):

    def __init__(self, **kwargs):
        (super().__init__)(disabled_name='set_to_default_model', 
         enabled_name='set_to_custom_model', 
         tunable=TunableModel(description='\n                Specify the model to use.\n                '), **kwargs)