...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\crafting\crafting_grab_serving_mixin.py
# Compiled at: 2019-04-29 16:15:29
...
class GrabServingMixin:
    ...
    def _setup_crafted_object(self, recipe, servings_source, crafted_object):
        ...
        crafting_process.setup_crafted_object(crafted_object, use_base_recipe=(self.use_base_recipe_on_setup), is_final_product=True,
          owning_household_id_override=(servings_source.get_household_owner_id()))
