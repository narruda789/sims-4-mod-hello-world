...
class Recipe(metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.RECIPE)):
    ...
    def _tuning_loaded_callback(cls):
        ...
        if cls.ingredient_cost_only_ingredients:
            cls.sorted_ingredients_only_requirements = sorted((cls.ingredient_cost_only_ingredients.ingredient_list), key=(lambda x: x.factory.get_sort_index()))
