...
class TunableSimCreator(TunableFactory):
    ...
    def factory(age_variant=None, full_name=None, **kwargs):
        ...
        return (sims.sim_spawner.SimCreator)(age=age_of_sim, full_name_key=full_name_key, 
         first_name_key=first_name_key, 
         last_name_key=last_name_key, 
         sim_name_type=sim_name_type, **kwargs)
    ...
    def _add_traits(cls, sim_info, sim_creator=None):
        ...
        if cls._traits.num_random:
            ...
            if num_to_add > 0:
                ...
                available_trait_types = {trait for trait in trait_manager.types.values() if not sim_info.has_trait(trait)}
    ...
    def add_perks(cls, sim_info, sim_creator=None, suppress_telemetry=False):
        ...
        if cls._perks.num_random:
            ...
            if num_to_add > 0:
                ...
                available_bucks_perk_types = {perk for perk in bucks_perk_manager.types.values() if cls._perks.whiteblacklist.test_item(perk)}
