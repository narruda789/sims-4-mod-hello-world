...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\visualization\locator_visualizer.py
# Compiled at: 2019-02-07 21:13:27
    ...
    def _draw_locators(self):
        ...
        with Context(self.layer) as (layer):
            ...
            if ocean is not None:
                species = [
                 Species.HUMAN, Species.DOG]
                age = [Age.TODDLER, Age.CHILD, Age.ADULT]
                interval = {WaterDepthIntervals.WET: Color.BLUE, 
