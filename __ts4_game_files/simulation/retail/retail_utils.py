...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\retail\retail_utils.py
# Compiled at: 2017-10-16 19:07:52
...
import objects.components.types, services, tag
    ...
    def all_retail_objects_gen(cls, allow_for_sale=True, allow_sold=True, allow_not_for_sale=False, include_inventories=True):
        ...
        for obj in services.object_manager().valid_objects():
            ...
            if obj.has_component(objects.components.types.RETAIL_COMPONENT):
                if allow_for_sale:
                    if not (obj.retail_component.is_for_sale or allow_sold and obj.retail_component.is_sold):
                        if not allow_not_for_sale or obj.retail_component.is_not_for_sale:
                            yield obj
                elif allow_for_sale:
                    if include_inventories and obj.has_component(objects.components.types.INVENTORY_COMPONENT):
