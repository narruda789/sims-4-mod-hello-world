...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\zone_modifier\zone_modifier_from_objects_actions.py
# Compiled at: 2020-10-06 16:58:09
...
class ZoneModifierFromObjectsActionVariants(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, convergence_change=ZoneModifierFromObjectsActionConvergenceChange.TunableFactory(), 
         statistic_change=ZoneModifierFromObjectsActionStatisticChange.TunableFactory(), 
         statistic_modifier=ZoneModifierFromObjectsActionStatisticModifier.TunableFactory(), 
         default='statistic_change', **kwargs)
