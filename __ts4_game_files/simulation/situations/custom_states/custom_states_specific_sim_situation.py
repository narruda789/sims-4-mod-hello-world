...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\custom_states\custom_states_specific_sim_situation.py
# Compiled at: 2020-08-06 21:31:03
...
class SpecificSimCustomStatesSituation(CustomStatesSituation):
    ...
    def get_predefined_guest_list(cls):
        ...
        guest_list.add_guest_info(SituationGuestInfo((filter_result[0].sim_info.sim_id), (cls.specific_sim_job),
          (RequestSpawningOption.DONT_CARE),
          (BouncerRequestPriority.EVENT_VIP),
          expectation_preference=(cls.specific_sim_expectation_preference)))
        return guest_list