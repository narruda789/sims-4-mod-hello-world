...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\visiting\visiting_interactions.py
# Compiled at: 2020-03-11 22:21:43
# Size of source mod 2**32: 6527 bytes
...
import interactions, services, sims4
...
class RingDoorbellSuperInteraction(SuperInteraction):
    ...
    def _try_to_be_invited_in(self):
        ...
        for sim_info in occupants:
            ...
            if sim is None or sim.has_running_and_queued_interactions_with_liability(interactions.rabbit_hole.HIDE_SIM_LIABILTIY):
                num_occupants -= 1
