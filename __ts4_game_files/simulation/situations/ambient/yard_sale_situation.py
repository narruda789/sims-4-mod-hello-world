...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\ambient\yard_sale_situation.py
# Compiled at: 2016-09-01 18:51:12
# Size of source mod 2**32: 6633 bytes
...
class ManageCustomersState(CommonSituationState):
    ...
    def on_activate(self, reader=None):
        ...
        self._create_or_load_alarm(SITUATION_ALARM, (self.time_between_customer_checks),
...
class YardSaleSituation(SituationComplexCommon):
    ...
    def create_customer_situation(self):
        situation_manager = services.get_zone_situation_manager()
        situation_id = situation_manager.create_situation((self.customer_situation), guest_list=None,
          user_facing=False)
        self.customer_situations.append(situation_id)


lock_instance_tunables(YardSaleSituation, exclusivity=(BouncerExclusivityCategory.VENUE_BACKGROUND),
