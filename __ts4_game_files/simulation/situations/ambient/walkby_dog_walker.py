...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\ambient\walkby_dog_walker.py
# Compiled at: 2021-05-14 16:15:05
# Size of source mod 2**32: 10963 bytes
import itertools
...
class WalkbyDogWalker(SituationComplexCommon):
    INSTANCE_TUNABLES = {'group_filter':TunableAggregateFilter.TunableReference(description='\n            The aggregate filter that we use to find the sims for this\n            situation.\n            '), 
     ...
     'leave_state':LeaveState.TunableFactory(description='\n            The state for the adoption officer to leave.\n            ',
       locked_args={'allow_join_situation': False}), 
     'dog_walker':TunableTuple(situation_job=SituationJob.TunableReference(description='\n                The Situation Job of the dog walker.\n                '),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [(cls.dog_walker.situation_job, cls.dog_walker.initial_role_state),
         (
...
sims4.tuning.instances.lock_instance_tunables(WalkbyDogWalker, exclusivity=(BouncerExclusivityCategory.WALKBY),
