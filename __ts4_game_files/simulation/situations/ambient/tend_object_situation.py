...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\ambient\tend_object_situation.py
...
lock_instance_tunables(TendObjectSituation, exclusivity=(BouncerExclusivityCategory.VENUE_EMPLOYEE),
