...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\university_graduation_situation.py
# Compiled at: 2019-10-22 21:43:55
...
class UniversityGraduationSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (SituationStateData(1, _GatherState, factory=(cls.gather_state)),
         SituationStateData(2, _CeremonyState, factory=(cls.ceremony_state)),
         SituationStateData(3, _CelebrationState, factory=(cls.celebration_state)))
        ...
        for sim_info in services.active_household().sim_info_gen():
            ...
            if sim_info.id != host_sim_info.id and degree_tracker.get_university() == host_university and degree_tracker.get_enrollment_status() == EnrollmentStatus.GRADUATED:
                request = BouncerRequest(self, callback_data=(_RequestUserData()),
                  job_type=(self.household_member_job_and_role_state.job),
