...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\gym_situation.py
# Compiled at: 2021-09-01 13:58:18
# Size of source mod 2**32: 9583 bytes
...
class _ExerciseState(CommonSituationState):
    ...
    def on_activate(self, reader=None):
        ...
        if self._exercise_timeout is not None:
            ...
            self._create_or_load_alarm(EXERCISE_TIMEOUT, duration, (lambda _: self.timer_expired()),
...
class GymVisitorSituation(SituationComplexCommon):
    INSTANCE_TUNABLES = {'situation_default_job':SituationJob.TunableReference(description='\n            The default job that a visitor will be in during the situation.\n            '), 
     ...
     'take_shower_state':_TakeShowerState.TunableFactory(description='\n            The main state of the situation. This is where Sims will do \n            everything except for arrive and leave.\n            ',
       tuning_group=SituationComplexCommon.SITUATION_STATE_GROUP,
       display_name='02_take_shower_state'), 
     'do_stuff_state':_DoStuffState.TunableFactory(description='\n            The main state of the situation. This is where Sims will do \n            everything except for arrive and leave.\n            ',
       tuning_group=SituationComplexCommon.SITUATION_STATE_GROUP,
    ...
    @classmethod
    def _states(cls):
        return [SituationStateData(1, _ExerciseState, factory=(cls.exercise_state)),
         SituationStateData(2, _TakeShowerState, factory=(cls.take_shower_state)),
