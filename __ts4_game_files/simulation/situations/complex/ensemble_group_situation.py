...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\ensemble_group_situation.py
# Compiled at: 2017-06-14 14:59:31
...
import filters, services, sims4.log
...
class EnsembleGroupSituation(SituationComplexCommon):
    ...
    def get_predefined_guest_list(cls):
        ...
        filter_results = services.sim_filter_service().submit_matching_filter(sim_filter=worker_filter, allow_yielding=False,
          number_of_sims_to_find=(cls.num_sims.random_int()),
    ...
    def _on_set_sim_job(self, sim, job_type):
        ...
        situation_id = situation_manager.create_situation((self.individual_sim_situation), guest_list=guest_list,
          user_facing=False)
    ...
    def _on_remove_sim_from_situation(self, sim):
        ...
        for situation_id in self._individual_sim_situations:
            ...
            if situation is None or situation.is_sim_in_situation(sim):
...
lock_instance_tunables(EnsembleGroupSituation, exclusivity=(BouncerExclusivityCategory.NEUTRAL),
