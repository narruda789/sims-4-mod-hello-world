...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\complex\charity_benefit_party.py
# Compiled at: 2018-08-03 19:13:53
# Size of source mod 2**32: 4938 bytes
...
class CharityBenefitPartySituation(SituationComplexCommon):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [(cls.host.situation_job, cls.host.host_benefit_role_state),
         (
          cls.bartender.situation_job, cls.bartender.bartender_benefit_role_state),
         (
          cls.caterer.situation_job, cls.caterer.caterer_benefit_role_state),
         (
          cls.entertainer.situation_job, cls.entertainer.entertainer_benefit_role_state),
         (
