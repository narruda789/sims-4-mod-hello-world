...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\situations\situation_water_scooter_walkby.py
# Compiled at: 2019-03-15 21:12:11
...
import services, sims4.tuning.instances
...
class SituationWaterScooterWalkby(SituationComplexCommon):
    ...
    @classmethod
    def _states(cls):
        return (SituationStateData(1, _DeployWaterScooterState, factory=(cls.deploy_water_scooter_state)),
         SituationStateData(2, _GetOnWaterScooterState, factory=(cls.get_on_water_scooter_state)),
         SituationStateData(3, _RideAroundState, factory=(cls.ride_around_state)),
         SituationStateData(4, _PutInInventoryState, factory=(cls.put_in_inventory_state)),
         SituationStateData(5, _LeaveState, factory=(cls.leave_state)))
