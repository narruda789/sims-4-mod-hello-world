...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\headlines\headline.py
# Compiled at: 2020-04-07 20:54:06
...
from sims4.tuning.tunable import OptionalTunable, TunableTuple, Tunable, TunableEnumEntry, HasTunableReference, TunableMapping, TunableColor
...
class HeadlineUpdateData(TunableTuple):
  ...
  tunable_type=float,
  default=1.0), 
         fx=TunableEnumEntry(description='\n                The fx on the flash timeline that should be used.\n                ',
  tunable_type=FXType,
  default=(FXType.NO_EFFECT)), 
         color=TunableColor.TunableColorRGBA(description='\n                The color of the headline.\n                ',
  tuning_group=(GroupNames.UI)), **kwargs)
...
class Headline(HasTunableReference, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.HEADLINE)):
    INSTANCE_TUNABLES = {'text':OptionalTunable(description='\n            If enabled then this headline will have text displayed along the\n            icon.\n            ',
       ...
       export_class_name='HeadlineTextOptionalTunable'), 
     'levels':TunableMapping(description='\n            Different Headline update levels.\n            ',
       key_type=Tunable(description='\n                The level key.\n                ',
       tunable_type=int,
       default=1),
       value_type=HeadlineUpdateData(description='\n                Level data.\n                '),
       tuple_name='HeadlineLevelMapping',
       export_modes=ExportModes.All), 
