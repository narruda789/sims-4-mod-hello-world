...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\autonomy\autonomy_util.py
# Compiled at: 2017-07-11 17:56:50
# Size of source mod 2**32: 23469 bytes
from _collections import defaultdict
from collections import Counter
import time
from contextlib import contextmanager
from sims4.utils import create_csv
import enum, services, sims4.log, sims4.reload
...
class AutonomyProfilingData:
    ...
    def write_profiling_data_to_file(self, file):
        ...
        autonomy_key_order = [
         'FullAutonomy', 'SubActionAutonomy', 'SocialAutonomy', 'ParameterizedAutonomy', 'CraftingRequest']
...
class AutonomyAffordanceTimes:
    ...
    def _finish_profile(self, affordance_name):
        ...
        if self._total_start is None:
            return
        elif affordance_name in self._affordances:
            total_count, total_total, total_distance, total_transition, total_compat = self._affordances[affordance_name]
        else:
            total_count, total_total, total_distance, total_transition, total_compat = (0,
                                                                                        0.0,
                                                                                        0.0,
                                                                                        0.0,
                                                                                        0.0)
        ...
        self._affordances[affordance_name] = (total_count + 1,
         total_total,
         total_distance,
         total_transition,
         total_compat)
    ...
    def dump(cls, connection=None):
        if cls._affordance_times is None:
            ...
            return affordance_times or None
