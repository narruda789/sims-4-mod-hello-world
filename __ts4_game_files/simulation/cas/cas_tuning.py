...
from cas.cas_enums import CASPaintPose, CASMode, CASMenuState, CASRandomizeFlag, SimRegion, CASEditMode, CASSkinToneType
...
class CASContextCriterion(TunableVariant):
 ...
 SpeciesExtended.INVALID,)), 
  ...
  tunable_type=bool,
  default=False), 
         is_fashion_mode=Tunable(description='\n                Check if currently in fashion mode.\n                ',
  tunable_type=bool,
  default=False), 
