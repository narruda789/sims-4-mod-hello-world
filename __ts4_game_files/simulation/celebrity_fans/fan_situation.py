...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\celebrity_fans\fan_situation.py
# Compiled at: 2018-07-18 15:37:25
...
lock_instance_tunables(FanSituation, exclusivity=(BouncerExclusivityCategory.NORMAL),
...
class StanSituation(FanSituation):
    ...
    def _gsi_additional_data_gen(self):
        yield (
         'Stanned Sim', str(self.initiating_sim_info))