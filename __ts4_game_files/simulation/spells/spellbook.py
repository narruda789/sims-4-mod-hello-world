...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\spells\spellbook.py
# Compiled at: 2019-06-17 16:21:27
# Size of source mod 2**32: 16966 bytes
import itertools
...
class _SpellbookCategoryHelper:
    ...
    def _populate_spell_entry_message(self, entry_message, spell):
        ...
        if spell.locked_description:
            entry_message.description = self._is_unlocked(spell) or spell.locked_description
        else:
    ...
    def _populate_recipe_entry_message(self, entry_message, recipe):
        ...
        if recipe_display_data is None:
            ...
            return
        if recipe_display_data.locked_description:
            entry_message.description = self._is_unlocked(recipe) or recipe_display_data.locked_description
        else:
            if recipe_display_data.potion_description is not None:
