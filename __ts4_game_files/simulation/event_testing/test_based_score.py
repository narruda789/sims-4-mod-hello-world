...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\event_testing\test_based_score.py
...
class TestBasedScore(HasTunableReference, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.TEST_BASED_SCORE)):
        ...
        for test_pair in remaining_scores:
            ...
            if resolver(test_pair.test):
                ...
                if threshold.compare(current_score):
                    ...
                    return threshold.compare(current_score + available_score) or False
