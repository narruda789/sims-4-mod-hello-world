...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\event_testing\objective_tuning.py
# Compiled at: 2022-06-13 18:18:17
# Size of source mod 2**32: 54016 bytes
...
from sims4.tuning.tunable import TunableVariant, HasTunableSingletonFactory, AutoFactoryInit, OptionalTunable, TunableEnumSet, Tunable, TunableList
from sims4.tuning.tunable_base import GroupNames
from sims4.utils import classproperty, constproperty
from vfx import TunablePlayEffectVariant
import aspirations.aspiration_tests, enum
import event_testing.results as results
import event_testing.test_variants, event_testing.tests
import event_testing.tests_with_data as tests_with_data
import objects.object_tests, services, sims.sim_info_tests, sims4.log, sims4.tuning.tunable, statistics.skill_tests, tag, world.world_tests, zone_tests
...
class TunableObjectiveTestVariant(TunableVariant):
    ...
    def __init__(self, description='A tunable test supported for use as an objective.', **kwargs):
        (super().__init__)(at_work=event_testing.test_variants.AtWorkTest.TunableFactory(locked_args={'subject':ParticipantType.Actor, 
 'tooltip':None}), 
         bucks_test=BucksTest.TunableFactory(locked_args={'subject':ParticipantType.Actor, 
 'tooltip':None}), 
         buff_added=sims.sim_info_tests.BuffAddedTest.TunableFactory(locked_args={'tooltip': None}), 
         career_attendence=tests_with_data.TunableCareerAttendenceTest(locked_args={'tooltip': None}), 
         career_promoted=event_testing.test_variants.CareerPromotedTest.TunableFactory(locked_args={'tooltip': None}), 
         career_test=event_testing.test_variants.TunableCareerTest.TunableFactory(locked_args={'subjects':ParticipantType.Actor, 
 'tooltip':None}), 
         collected_item_test=event_testing.test_variants.CollectedItemTest.TunableFactory(locked_args={'tooltip': None}), 
         collection_test=event_testing.test_variants.TunableCollectionThresholdTest(locked_args={'who':ParticipantType.Actor, 
 'tooltip':None}), 
         crafted_item=objects.object_tests.CraftedItemTest.TunableFactory(locked_args={'tooltip': None}), 
         familial_trigger_test=tests_with_data.TunableFamilyAspirationTriggerTest(locked_args={'tooltip': None}), 
         generation_created=tests_with_data.GenerationTest.TunableFactory(locked_args={'tooltip': None}), 
         has_buff=sims.sim_info_tests.BuffTest.TunableFactory(locked_args={'subject':ParticipantType.Actor, 
 'tooltip':None}), 
         household_size=event_testing.test_variants.HouseholdSizeTest.TunableFactory(locked_args={'participant':ParticipantType.Actor, 
 'tooltip':None}), 
         in_multiple_moods=event_testing.tests_with_data.InMultipleMoodsTest.TunableFactory(locked_args={'tooltip': None}), 
         inventory=objects.object_tests.InventoryTest.TunableFactory(locked_args={'tooltip': None}), 
         mood_test=sims.sim_info_tests.MoodTest.TunableFactory(locked_args={'who':ParticipantTypeSim.Actor, 
 'tooltip':None}), 
         object_criteria=objects.object_tests.ObjectCriteriaTest.TunableFactory(locked_args={'tooltip': None}), 
         object_purchase_test=objects.object_tests.ObjectPurchasedTest.TunableFactory(locked_args={'tooltip': None}), 
         object_relationship_test=objects.object_tests.ObjectRelationshipTest.TunableFactory(locked_args={'sims':ParticipantType.Actor, 
 'tooltip':None}), 
         offspring_created_test=tests_with_data.OffspringCreatedTest.TunableFactory(locked_args={'tooltip': None}), 
         ran_away_action_test=tests_with_data.TunableParticipantRanAwayActionTest(locked_args={'participant':ParticipantTypeActorTargetSim.Actor, 
 'tooltip':None}), 
         ran_interaction_test=tests_with_data.TunableParticipantRanInteractionTest(locked_args={'participant':ParticipantType.Actor, 
 'tooltip':None}), 
 ...
 'tooltip':None}), 
         ...
         selected_aspiration_test=aspirations.aspiration_tests.SelectedAspirationTest.TunableFactory(locked_args={'who':ParticipantTypeSingleSim.Actor, 
 'tooltip':None}), 
         selected_aspiration_track_test=aspirations.aspiration_tests.SelectedAspirationTrackTest.TunableFactory(locked_args={'who':ParticipantTypeSingleSim.Actor, 
 'tooltip':None}), 
         simoleons_earned=tests_with_data.TunableSimoleonsEarnedTest(locked_args={'tooltip': None}), 
         simoleon_value=event_testing.test_variants.TunableSimoleonsTest(locked_args={'tooltip': None}), 
         situation_running_test=event_testing.test_variants.TunableSituationRunningTest(locked_args={'tooltip': None}), 
         skill_tag=statistics.skill_tests.SkillTagThresholdTest.TunableFactory(locked_args={'who':ParticipantType.Actor, 
 'tooltip':None}), 
         statistic=event_testing.statistic_tests.StatThresholdTest.TunableFactory(locked_args={'who':ParticipantType.Actor, 
 'tooltip':None}), 
         ranked_statistic=event_testing.statistic_tests.RankedStatThresholdTest.TunableFactory(locked_args={'who':ParticipantType.Actor, 
 'tooltip':None}), 
         total_simoleons_earned=event_testing.test_variants.TunableTotalSimoleonsEarnedTest(locked_args={'tooltip': None}), 
         total_interaction_time_elapsed_by_tag=tests_with_data.TunableTotalTimeElapsedByTagTest(locked_args={'tooltip': None}), 
         total_relationship_bit=tests_with_data.TunableTotalRelationshipBitTest(locked_args={'tooltip': None}), 
         total_simoleons_earned_by_tag=tests_with_data.TunableTotalSimoleonsEarnedByTagTest(locked_args={'tooltip': None}), 
         total_time_played=event_testing.test_variants.TunableTotalTimePlayedTest(locked_args={'tooltip': None}), 
         total_zones_traveled=tests_with_data.TunableTotalTravelTest(locked_args={'tooltip': None}), 
 ...
 ParticipantTypeActorHousehold.Actor),
  locked_args={'tooltip': None}), 
         unlock_earned=event_testing.test_variants.TunableUnlockedTest(locked_args={'participant':ParticipantType.Actor, 
 'tooltip':None}), 
         unlock_tracker_amount=sims.unlock_tracker_tests.UnlockTrackerAmountTest.TunableFactory(locked_args={'subject':ParticipantType.Actor, 
 'tooltip':None}), 
         whim_completed_test=tests_with_data.WhimCompletedTest.TunableFactory(locked_args={'tooltip': None}), 
         zone=zone_tests.ZoneTest.TunableFactory(locked_args={'tooltip': None}), 
         location_test=world.world_tests.LocationTest.TunableFactory(location_tests={'is_outside':False, 
...
class _ObjectiveCompletionType(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def on_increment_objective_data(self, event_data_tracker):
        if self.increment_vfx:
            if not event_data_tracker.simless:
...
class SimInfoStatisticObjectiveTrack(_ObjectiveCompletionType):
    ...
    def increment_data(self, objective, resolver, event_data_tracker, result, additional_result):
        ...
        return results.TestResultNumeric(False, 'Objective: not possible because sim info panel member.',
          current_value=count,
          goal_value=0,
          is_money=False)
...
class _UniqueTargetsObjectiveTrack(_ObjectiveCompletionType):
    ...
    def increment_data(self, objective, resolver, event_data_tracker, result, additional_result):
        ...
        if count < self.unique_targets_required_to_pass:
            return results.TestResultNumeric(False, 'Objective: not enough iterations.',
              current_value=count,
...
class _UniqueLocationsObjectiveTrack(_ObjectiveCompletionType):
    ...
    def increment_data(self, objective, resolver, event_data_tracker, result, additional_result):
        ...
        if count < self.unique_locations_required_to_pass:
            return results.TestResultNumeric(False, 'Objective: not enough matching location iterations.',
              current_value=count,
...
class _UniqueWorldsObjectiveTrack(_ObjectiveCompletionType):
    ...
    def increment_data(self, objective, resolver, event_data_tracker, result, additional_result):
        ...
        if count < self.unique_worlds_required_to_pass:
            return results.TestResultNumeric(False, 'Objective: not enough matching world iterations.',
              current_value=count,
    ...
    def increment_data(self, objective, resolver, event_data_tracker, result, additional_result):
        ...
        if result:
            if additional_result:
                ...
                if sim is None:
                    return results.TestResultNumeric(False, "Objective: Couldn't find sim instance.",
                ...
                if user_facing_situation_id == 0:
                    return results.TestResultNumeric(False, 'Objective: Sim is not currently in a situation.',
                      current_value=(data_object.get_objective_count(objective)),
                      goal_value=(self.iterations_required_to_pass),
                      is_money=False)
...
class _UseTestResult(_ObjectiveCompletionType):
    ...
    def increment_data(self, objective, resolver, event_data_tracker, result, additional_result):
        ...
        if result:
            ...
            return isinstance(result, TestResultNumeric) or result
...
class BaseObjective:
    INSTANCE_TUNABLES = {'display_text':TunableLocalizedStringFactory(description='\n            The single line description of the objective as it appears in\n            various panels.\n            ',
     ...
     'display_age_list':OptionalTunable(description='\n            If enabled, the Sim must be one of the specified ages for the\n            Objective to be displayed in the UI.  This does not create any\n            Gameplay side checks to prevent this Objective from being completed\n            anyways.\n            ',
      ...
      Age.ELDER]),
       ...
       export_class_name='DisplayAgeListOptionalTunable',
       export_modes=sims4.tuning.tunable_base.ExportModes.All,
       tuning_group=GroupNames.UI), 
     'satisfaction_points':sims4.tuning.tunable.Tunable(description='\n            The number of satisfaction points received upon the completion of\n            this Objective.\n            ',
       tunable_type=int,
       default=0,
       export_modes=sims4.tuning.tunable_base.ExportModes.All,
    ...
    def increment_data(cls, resolver):
        return results.TestResultNumeric(False, "Objective doesn't have a tuned completion type.",
          current_value=0,
    ...
    @classmethod
    def apply_completion_loot(cls, sim_info):
        pass
...
class Objective(BaseObjective, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.OBJECTIVE)):
    INSTANCE_TUNABLES = {'objective_test':TunableObjectiveTestVariant(description='\n            The test to run in order to mark this Objective as complete.\n            ',
     ...
     'additional_tests':event_testing.tests.TunableTestSet(description='\n            Additional tests that must be true when the Objective Test passes\n            in order for the Objective consider having passed.\n            \n            Note: This does not run if you are using Use Test Result as the\n            Objective Completion Type.\n            ',
       tuning_group=GroupNames.CORE), 
     'objective_completion_type':TunableVariant(iterations=_IterationsObjectiveTrack.TunableFactory(),
       sim_info_statistic=SimInfoStatisticObjectiveTrack.TunableFactory(),
       unique_targets=_UniqueTargetsObjectiveTrack.TunableFactory(),
       unique_locations=_UniqueLocationsObjectiveTrack.TunableFactory(),
       unique_worlds=_UniqueWorldsObjectiveTrack.TunableFactory(),
       tag_checklist=_TagChecklistObjectiveTrack.TunableFactory(),
       iterations_single_situation=_IterationsSingleSituation.TunableFactory(),
       use_test_result=_UseTestResult.TunableFactory(),
       default='iterations',
    ...
    @classmethod
    def increment_data(cls, resolver, event_data_tracker):
        return cls.objective_completion_type.increment_data(cls, resolver, event_data_tracker, results.TestResult.TRUE, results.TestResult.TRUE)

    @classmethod
    def run_test(cls, event, resolver, event_data_tracker):
        if event not in cls.objective_test.test_events:
            if event != TestEvent.UpdateObjectiveData:
                return results.TestResult(False, 'Objective test not present in event set.')
        elif not cls.objective_completion_type.check_if_should_test(resolver):
    ...
    @classmethod
    def should_test_on_zone_load(cls):
        return cls.objective_completion_type.should_test_on_zone_load

    @classmethod
    def apply_completion_loot(cls, sim_info):
        resolver = SingleSimResolver(sim_info)
        for loot_action in cls.completion_loot:
