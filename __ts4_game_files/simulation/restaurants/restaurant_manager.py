...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\restaurants\restaurant_manager.py
# Compiled at: 2021-09-01 13:58:18
# Size of source mod 2**32: 20506 bytes
...
class RestaurantManager(HasAdvertisingManagerMixin, BusinessManager):
    ...
    def set_states_for_recipe(self, recipe, recipe_instance, chef):
        ...
        if total < RestaurantTuning.CHEF_NOT_SKILLED_ENOUGH_THRESHOLD:
            ...
            return business_manager is None or business_manager.is_owner_household_active or None
    ...
    def load_data(self, business_save_data, is_legacy=False):
        ...
        if profit_per_meal_save_data:
            if len(profit_per_meal_save_data) > RestaurantTuning.MEAL_COUNT_FOR_OFF_LOT_PROFIT_PER_MEAL:
