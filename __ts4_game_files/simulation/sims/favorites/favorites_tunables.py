...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\favorites\favorites_tunables.py
# Compiled at: 2020-04-08 14:24:58
...
class FavoriteObjectPropAnimationOverrides(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    class _FromObjectStateValue(HasTunableSingletonFactory, AutoFactoryInit):
        FACTORY_TUNABLES = {'state_value': TunableReference(manager=(services.get_instance_manager(Types.OBJECT_STATE)),
    ...
    FACTORY_TUNABLES = {'favorite_prop_anim_overrides': TunableVariant(description='\n            Animation overrides to apply.\n            ',
                                       specific_overrides=(_SpecificOverrides.TunableFactory()),
                                       from_object_state_value=(_FromObjectStateValue.TunableFactory()),
                                       default='specific_overrides')}
...
class FavoriteObjectPropAnimationOverridesVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(matches_definitions=(WithObjectDefinitionPropAnimationOverrides.TunableFactory()),
          matches_state=(WithObjectStatePropAnimationOverrides.TunableFactory()),
          default='matches_definitions')
