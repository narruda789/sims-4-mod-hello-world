...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\favorites\favorites_loot.py
# Compiled at: 2020-07-27 15:15:41
...
class SetFavoriteLootOp(BaseTargetedLootOperation):
    ...
    def _apply_to_subject_and_target(self, subject, target, resolver):
        if subject is None:
            ...
            return
            if target is None:
                if self._favorite_type is None or self._favorite_type.favorite_definition is None:
            ...
            if favorites_tracker is None:
                ...
                return
        elif self._favorite_type is not None:
