...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\sims\sim_info_firemeter.py
# Compiled at: 2016-10-28 19:07:43
...
class SimInfoFireMeter:
    ...
    def __init__(self):
        self._alarm_handle = alarms.add_alarm(self, create_time_span(minutes=(self.FIREMETER_FREQUENCY)),
