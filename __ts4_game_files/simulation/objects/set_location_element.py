...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\set_location_element.py
# Compiled at: 2020-10-19 13:13:10
...
class TunableTransform(TunableSingletonFactory):
    ...
    def __init__(self, description='A tunable transform', **kwargs):
        (super().__init__)(offset=TunableTuple(x=Tunable(tunable_type=float, default=0.0),
  y=Tunable(tunable_type=float, default=0.0),
  z=Tunable(tunable_type=float, default=0.0)), 
         quaternion=TunableTuple(x=Tunable(tunable_type=float, default=0.0),
  y=Tunable(tunable_type=float, default=0.0),
  z=Tunable(tunable_type=float, default=0.0),
  w=Tunable(tunable_type=float, default=1.0)), 
