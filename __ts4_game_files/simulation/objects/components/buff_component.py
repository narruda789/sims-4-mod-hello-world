...
# Size of source mod 2**32: 84816 bytes
...
True # Avoid dead code: False))
    ...
    def _create_buff_update_msg(self, buff, update_type, change_rate=None):
        ...
        elif update_type == BuffUpdateType.ADD or update_type == BuffUpdateType.UPDATE:
...
class BuffPickerSuperInteraction(PickerSuperInteraction):
 ...
 L.1648         0  LOAD_FAST                'cls'
                2  LOAD_ATTR                is_add
                4  POP_JUMP_IF_FALSE   110  'to 110'

 L.1649         6  LOAD_FAST                'cls'
                8  LOAD_ATTR                buffs
               10  POP_JUMP_IF_FALSE    52  'to 52'

 L.1650        12  SETUP_LOOP          108  'to 108'
               14  LOAD_FAST                'cls'
               16  LOAD_ATTR                buffs
               18  GET_ITER         
 ...
 L.1653        52  LOAD_GLOBAL              services
 ...
 L.1654        68  SETUP_LOOP          148  'to 148'
 ...
 L.1657       110  SETUP_LOOP          148  'to 148'
 ...
 L.1658       124  LOAD_FAST                'buff_type'
