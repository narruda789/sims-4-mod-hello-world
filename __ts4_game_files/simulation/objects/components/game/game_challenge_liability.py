...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\game\game_challenge_liability.py
# Compiled at: 2015-10-23 21:06:49
...
class GameChallengeLiability(HasTunableFactory, AutoFactoryInit, SharedLiability):
    ...
    def create_new_liability(self, interaction):
        liability = super().create_new_liability(interaction, interaction, game=(self._game), challenge_buff=(self.challenge_buff),
