...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\game\game_card_battle_behavior.py
# Compiled at: 2020-06-15 17:54:40
# Size of source mod 2**32: 18682 bytes
import random
...
class CardBattleBehavior(HasTunableFactory, AutoFactoryInit):
    ...
    def on_player_added(self, sim, target):
        ...
        if slotted_objects:
            ...
            self._players_cards[sim] = (
             player_card, from_inventory, reservation_handler)
    ...
    def _get_slot_for_sim_position(self, target, sim_position):
        ...
        for runtime_slot in target.part_owner.get_runtime_slots_gen(slot_types={self.card_slot_type}):
            ...
            if max_magnitude is None or difference_magnitude < max_magnitude:
    ...
    def _set_prop_override(self, prop_overrides, override_name, card_definition):
        prop_overrides[override_name] = sims4.collections.FrozenAttributeDict({'states_to_override':(), 
         'special_cases':None, 
         'from_actor':None, 
