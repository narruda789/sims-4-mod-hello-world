...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\components\waiting_line_component.py
# Compiled at: 2020-09-25 14:57:29
...
class WaitingLine:
    ...
    def _init_line(self, waiting_interaction):
        ...
        self._line_constraint_target = line_head_data[4]
        self._line_update_timing = line_head_data[5]
...
class WaitingLineComponent(Component, component_name=WAITING_LINE_COMPONENT, allow_dynamic=True):
    ...
    def get_waiting_line_autonomy_multiplier(self, interaction):
        ...
        if interaction.waiting_line.autonomous_waiting_line_prefence_curve is not None:
            ...
            if WaitingLineComponent.DEFAULT_AUTONOMOUS_WAITING_LINE_PREFERENCE_CURVE is not None:
