...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\objects\pools\pool_seat.py
...
import caches, postures.posture_graph, services, sims4.math
...
class PoolSeat(GameObject):
    ...
    def supports_posture_spec(self, posture_spec, interaction=None, sim=None):
        if interaction is not None:
            ...
            return self.supported_posture_types or True
    ...
    def _compute_position_and_routing_surface_for_posture(self):
        ...
        return (
         (
          (
           world_location.position, world_location.routing_surface),), ((pool_location.position, pool_location.routing_surface),))
