...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\open_street_director\festival_open_street_director.py
# Compiled at: 2021-06-04 22:08:08
# Size of source mod 2**32: 33273 bytes
...
from tag import Tag
import alarms, build_buy, itertools, services, sims4.resources, tag
...
class BaseFestivalState(HasTunableFactory, AutoFactoryInit):
    ...
    def on_state_activated(self, reader=None, preroll_time_override=None):
        self.schedule_alarm((self.CHECK_SITUATION_ALARM_KEY), (self.CHECK_SITUATIONS_ALARM_TIME),
    ...
    def schedule_alarm(self, alarm_key, alarm_time, callback, repeating=False, should_persist=True, reader=None):
        ...
        alarm_handle = alarms.add_alarm(self, create_time_span(minutes=alarm_time),
          callback,
          repeating=repeating)
...
class SituationEndedFestivalState(BaseFestivalState):
    ...
    def on_state_activated(self, reader=None, preroll_time_override=None):
        ...
        for custom_event_key in itertools.chain(self.situations_of_interest, self.situation_tags_of_interest):
            custom_key_tuple = (
             TestEvent.SituationEnded, custom_event_key)
...
class TimedFestivalState(BaseFestivalState):
    ...
    def on_state_activated(self, reader=None, preroll_time_override=None):
        ...
        self.schedule_alarm((self.TIMEOUT_ALARM_KEY), alarm_time,
