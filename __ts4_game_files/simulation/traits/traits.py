...
# Size of source mod 2**32: 54936 bytes
...
from sims4.tuning.tunable import TunableResourceKey, OptionalTunable, TunableReference, TunableList, TunableEnumEntry, TunableSet, TunableMapping, Tunable, HasTunableReference, TunableTuple, TunableEnumFlags, TunableEnumWithFilter, TunableVariant, TunableInteractionAsmResourceKey, TunableStyle
...
class Trait(HasTunableReference, SuperAffordanceProviderMixin, TargetSuperAffordanceProviderMixin, HasTunableLodMixin, MixerActorMixin, MixerProviderMixin, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.TRAIT)):
 ...
 L. 999       246  SETUP_LOOP          292  'to 292'
              248  LOAD_FAST                'cls'
              250  LOAD_ATTR                buffs
              252  GET_ITER         
 ...
 L.1000       258  LOAD_FAST                'buff_reference'
 ...
 L.1002       292  SETUP_LOOP          332  'to 332'
              294  LOAD_FAST                'cls'
 ...
 L.1007       332  SETUP_LOOP          408  'to 408'
              334  LOAD_FAST                'cls'
