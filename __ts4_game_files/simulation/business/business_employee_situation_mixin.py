...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\business\business_employee_situation_mixin.py
# Compiled at: 2017-06-29 18:03:48
...
class BusinessEmployeeSituationMixin(BusinessSituationMixin):
    ...
    def _on_set_sim_job(self, sim, job_type):
        ...
        if business_manager is not None:
            ...
            if career is not None:
                if self._on_career_removed not in career.on_career_removed:
    ...
    def _destroy(self):
        ...
        if business_manager is not None:
            ...
            if employee_sim_info is not None:
                ...
                if career is not None:
                    if self._on_career_removed in career.on_career_removed:
    ...
    def _clock_in(self):
        ...
        business_manager = services.business_service().get_business_manager_for_zone()
        if business_manager is not None:
            if not business_manager.is_employee_clocked_in(employee_sim_info):
    ...
    def _clock_out(self):
        ...
        business_manager = services.business_service().get_business_manager_for_zone()
        if business_manager is not None:
            if business_manager.is_employee_clocked_in(employee_sim_info):
    ...
    def _update_work_buffs(self, *_, from_load=False, **__):
        ...
        if employee_sim_info is None:
            ...
            if business_manager is not None:
                if not business_manager.is_employee_clocked_in(employee_sim_info):
                    return
            return self.total_work_time_buffs or None
