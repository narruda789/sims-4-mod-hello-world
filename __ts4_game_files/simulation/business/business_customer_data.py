...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\business\business_customer_data.py
# Compiled at: 2022-02-09 13:21:46
# Size of source mod 2**32: 19924 bytes
...
class BusinessCustomerData:
    ...
    def _trigger_star_vfx_change(self, from_init=False):
        ...
        if tuning_data.customer_max_star_rating_vfx is not None:
            if star_rating == tuning_data.min_and_max_star_rating.upper_bound:
    ...
    def _trigger_final_star_rating_vfx(self):
        if self._business_manager.tuning_data.customer_final_star_rating_vfx is None:
            ...
            if sim is None:
                ...
                return
            final_star_vfx = sim.is_hidden() or self._business_manager.tuning_data.customer_final_star_rating_vfx(sim)
    ...
    def _set_star_rating(self, new_star_rating_value, buff_data):
        ...
        elif business_handlers.business_archiver.enabled:
            if vfx_to_play is not None:
