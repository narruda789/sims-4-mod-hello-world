...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\business\business_elements.py
# Compiled at: 2016-03-21 16:06:54
...
class BusinessBuyLot(XevtTriggeredElement):
    FACTORY_TUNABLES = {'business_type':TunableEnumEntry(description='\n            The type of business to create for the lot.\n            ',
     ...
     'lot_participant':TunableEnumEntry(description='\n            The lot to purchase. This is likely the Picked Zone ID from the map\n            view picker screen.\n            ',
       tunable_type=ParticipantTypeLot,
       default=ParticipantTypeLot.PickedZoneId)}
