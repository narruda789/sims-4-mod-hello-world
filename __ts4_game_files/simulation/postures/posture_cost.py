...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\postures\posture_cost.py
# Compiled at: 2019-01-16 22:00:43
...
class TunablePostureCostVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, default_cost=_PostureCostDefault.TunableFactory(), 
         custom_cost=_PostureCostCustom.TunableFactory(), 
         per_species_cost=_PostureCostSpecies.TunableFactory(), 
         default='default_cost', **kwargs)