...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\drama_scheduler\player_planned_drama_node.py
...
class PlayerPlannedDramaNode(BaseDramaNode):
    ...
    def try_move_special_object_from_hidden(self):
        ...
        if not ((situation_seed is None or situation_seed).special_object_definition_id and situation_seed.host_sim_id):
            return
