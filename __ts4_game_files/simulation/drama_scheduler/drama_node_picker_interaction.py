...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\drama_scheduler\drama_node_picker_interaction.py
# Compiled at: 2022-07-21 21:49:30
# Size of source mod 2**32: 7921 bytes
    ...
    def picker_rows_gen(cls, inst, target, context, **kwargs):
        ...
        for drama_node in drama_nodes:
            if drama_node.drama_node_type == DramaNodeType.PICKER:
                if inst_or_cls.buckets:
                    if drama_node.scoring is None or drama_node.scoring.bucket not in inst_or_cls.buckets:
                        continue
