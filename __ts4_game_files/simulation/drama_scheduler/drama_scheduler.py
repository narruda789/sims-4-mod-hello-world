...
# Size of source mod 2**32: 53644 bytes
from _collections import defaultdict
import itertools, math
from protocolbuffers import GameplaySaveData_pb2
from date_and_time import DateAndTime, TimeSpan, DAYS_PER_WEEK, create_date_and_time, create_time_span, sim_ticks_per_week, DATE_AND_TIME_ZERO
...
class DramaScheduleService(Service):
    ...
    def _schedule_weekly_nodes_gen(self, timeline=None):
        ...
        for scheduling_group, nodes in self._grouped_weekly_nodes.items():
            ...
            nodes_scheduled = [node_inst for node_inst in self._scheduled_nodes.values() if node_inst.weekly_scheduling_rules is not None if node_inst.weekly_scheduling_rules.scheduling_group == scheduling_group]
    ...
    def schedule_node(self, drama_node, resolver, specific_time=None, drama_inst=None, setup_kwargs={}, **constructor_kwargs):
        ...
        if self._is_node_on_cooldown(drama_node):
            ...
            return (drama_node_inst.schedule)(resolver, specific_time=specific_time, **setup_kwargs) or None
    ...
    def _process_weekly_schedule_gen(self, timeline):
        try:
            try:
                ...
                try:
                    logger.exception('Exception while scheduling weekly DramaNodes: ', exc=exception,
