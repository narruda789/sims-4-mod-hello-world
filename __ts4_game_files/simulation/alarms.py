...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\alarms.py
# Compiled at: 2017-10-10 21:17:04
# Size of source mod 2**32: 15531 bytes
import weakref
from date_and_time import TimeSpan
import date_and_time, elements, services, sims4.reload, sims4.log
...
def add_alarm(owner, time_span, callback, repeating=False, repeating_time_span=None, use_sleep_time=True, cross_zone=False):
    ...
    return AlarmHandle(owner, callback, (ts.sim_timeline), (initial_time + time_span),
      repeating=repeating,
...
def add_alarm_real_time(owner, time_span, callback, repeating=False, use_sleep_time=True, cross_zone=False):
    ts = services.time_service()
    return AlarmHandle(owner, callback, (ts.wall_clock_timeline), (ts.wall_clock_timeline.now + time_span),
      repeating=repeating,
