...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\zone_manager.py
# Compiled at: 2018-01-18 14:47:08
...
import persistence_error_types, services, sims4.gsi.dispatcher, sims4.zone_utils, zone
...
class ZoneManager(IndexedManager):
    ...
    def create_zone(self, zone_id, gameplay_zone_data, save_slot_data):
        ...
        elif save_slot_data is not None:
