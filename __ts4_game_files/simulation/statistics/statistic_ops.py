...
# Size of source mod 2**32: 94396 bytes
import random
...
class TunableStatisticChange(TunableVariant):
 ...
 amount=gain_type, **StatisticOperation.DEFAULT_PARTICIPANT_ARGUMENTS), 
    ...
    def _apply_relationship_operation(self, relationship_tracker, target_sim_id, **kwargs):
        if not self._add_track_if_not_present:
            ...
            if not services.relationship_service().has_relationship_track(actor_sim_id, target_sim_id, self._track):
                return
        (relationship_tracker.add_relationship_score)(target_sim_id, self._amount, track=self._track.stat_type, **kwargs)
...
class RandomSimStatisticAddRelationship(StatisticAddRelationship):
 ...
 L.1875        34  LOAD_FAST                'source_sim_info'
 ...
 L.1876        44  SETUP_LOOP          162  'to 162'
 ...
 L.1877        54  LOAD_GLOBAL              DoubleSimResolver
 ...
 L.1879        76  LOAD_FAST                'valid_sim_infos'
 ...
 L.1883       126  LOAD_GLOBAL              DoubleSimResolver
 ...
 L.1885       148  LOAD_FAST                'valid_sim_infos'
 ...
 L.1891       188  LOAD_FAST                'result'
              190  POP_JUMP_IF_FALSE   204  'to 204'

 L.1892       192  LOAD_FAST                'valid_sim_infos'
 ...
 L.1894       204  SETUP_LOOP          412  'to 412'
 ...
 L.1895       224  LOAD_FAST                'valid_sim_infos'
              226  POP_JUMP_IF_TRUE    230  'to 230'

 L.1896       228  BREAK_LOOP       
            230_0  COME_FROM           226  '226'

 L.1898       230  LOAD_GLOBAL              random
 ...
 L.1903       270  LOAD_FAST                'valid_sim_infos'
...
class StatisticAddRelationshipMultiple(RelationshipOperationBase):
    FACTORY_TUNABLES = {'amount':lambda *args, **kwargs: _get_tunable_amount(*args, **kwargs), 
    ...
    def _apply_relationship_operation(self, relationship_tracker, target_sim_id, **kwargs):
        for track in self._track_selection_strategy.get_tracks(relationship_tracker, target_sim_id):
            (relationship_tracker.add_relationship_score)(target_sim_id,
 self._amount, track=track.stat_type, **kwargs)
...
class StatisticSetRelationship(RelationshipOperation):
 ...
 self._value, track=self._track.stat_type, **kwargs)
...
class StatisticSetRelationshipMultiple(RelationshipOperationBase):
    ...
    def _apply_relationship_operation(self, relationship_tracker, target_sim_id, **kwargs):
        for track in self._track_selection_strategy.get_tracks(relationship_tracker, target_sim_id):
            (relationship_tracker.set_relationship_score)(target_sim_id,
 self._value, track=track.stat_type, **kwargs)
