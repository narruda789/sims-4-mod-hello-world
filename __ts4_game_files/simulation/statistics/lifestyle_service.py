...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\statistics\lifestyle_service.py
# Compiled at: 2020-10-02 18:29:04
...
class LifestyleService(Service):
    ...
    def __init__(self):
        ...
        self.trait_stat_to_ui_state_switcher = {TraitStatisticStates.LOCKED: LifestyleUiState.LOCKED, 
         TraitStatisticStates.IN_PROGRESS: LifestyleUiState.IN_PROGRESS, 
         TraitStatisticStates.UNLOCKED: LifestyleUiState.ACTIVE, 
         TraitStatisticStates.AT_RISK: LifestyleUiState.AT_RISK, 
         TraitStatisticStates.OPPOSING_AT_RISK: LifestyleUiState.LOCKED, 
         TraitStatisticStates.OPPOSING_UNLOCKED: LifestyleUiState.LOCKED, 
         TraitStatisticStates.OPPOSING_IN_PROGRESS: LifestyleUiState.LOCKED}
