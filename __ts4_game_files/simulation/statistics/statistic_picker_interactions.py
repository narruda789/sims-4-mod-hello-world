...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\statistics\statistic_picker_interactions.py
# Compiled at: 2017-11-02 18:18:29
# Size of source mod 2**32: 6143 bytes
...
class CheatSetStatSuperInteraction(PickerSuperInteraction):
    ...
    def _get_stat_name(self, stat):
        ...
        if stat_name:
            if stat.stat_name.hash is not 0:
