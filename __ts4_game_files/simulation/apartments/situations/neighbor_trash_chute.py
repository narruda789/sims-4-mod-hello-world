...
class NeighborTrashChuteSituation(SituationComplexCommon):
    ...
    def get_predefined_guest_list(cls):
        ...
        guest_list.add_guest_info(SituationGuestInfo(neighbor_sim_id, (cls.neighbor_job_and_role_state.job),
    ...
    def _get_neighbor(cls):
        active_sim_info = services.active_sim_info()
        neighbors = services.sim_filter_service().submit_filter((cls.neighbor_job_and_role_state.job.filter), callback=None,
...
lock_instance_tunables(NeighborTrashChuteSituation, exclusivity=(BouncerExclusivityCategory.WALKBY),
