...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\lot_decoration\decorated_state.py
# Compiled at: 2018-01-29 21:02:53
...
class DecoratedState(_DecoratedStateBase):
    ...
    def get_deco_state_gsi_data(self):
        ...
        for deco_location, decoration in self._custom_decorations.items():
            gsi_data.append({'deco_location':deco_location.name, 
