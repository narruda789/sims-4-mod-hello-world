...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\utils\exit_condition_manager.py
# Compiled at: 2019-04-24 13:42:56
# Size of source mod 2**32: 12001 bytes
...
class ConditionGroup:
    ...
    def __init__(self, conditions, conditional_action):
        ...
        self.progress_bar_condition = None
...
class ConditionalActionManager:
    ...
    def __init__(self):
        ...
        self.progress_bar_condition_group = None
    ...
    def get_percent_rate_for_best_exit_conditions(self, interaction):
        ...
        for condition_group in self:
            ...
            if action != ConditionalInteractionAction.GO_INERTIAL:
                if action != ConditionalInteractionAction.EXIT_NATURALLY:
                    if progress_bar_action == ProgressBarAction.NO_ACTION:
                        continue
            ...
            for condition in condition_group:
                ...
                if current_time <= 0:
                    continue
                if individual_time is None or individual_time < current_time:
                    ...
                    if progress_bar_action == ProgressBarAction.FORCE_USE_CONDITION:
                        return (
                         individual_percent, individual_rate_change)

            if individual_time is None:
                continue
            if group_time is None or group_time > individual_time:
        ...
        if group_time is not None:
            return (
             group_percent, group_rate_change)
        return (None, None)