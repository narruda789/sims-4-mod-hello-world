...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\utils\custom_camera_liability.py
# Compiled at: 2020-08-27 19:00:08
...
class CustomCameraLiability(Liability, HasTunableFactory, AutoFactoryInit):
    ...
    FACTORY_TUNABLES = {'camera_mode': TunableEnumEntry(description='\n            Desired custom camera mode.\n            ',
                      tunable_type=CustomCameraMode,
                      default=(CustomCameraMode.INVALID),
                      invalid_enums=(
                     CustomCameraMode.INVALID,))}
