...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\base\immediate_interaction.py
...
class ImmediateSuperInteraction(SuperInteraction):
    INSTANCE_TUNABLES = {'basic_content':TunableBasicContentSet(no_content=True,
       default='no_content'), 
     'basic_extras':TunableList(description='\n            Additional elements to run around the basic content of the interaction.\n            ',
       tunable=TunableVariant(add_to_household=(AddToHouseholdElement.TunableFactory()),
...
lock_instance_tunables(ImmediateSuperInteraction, allow_autonomous=False,
