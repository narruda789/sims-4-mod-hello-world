...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\social\social_throw_mixer_interaction.py
# Compiled at: 2018-05-17 19:51:19
...
import animation, services, sims4.math
...
class SocialThrowMixerInteraction(SocialMixerInteraction):
    ...
    def on_throw_impact(self, event_data):
        ...
        if not self._finished:
            if self.throw_impact_data.asm_state_name is not None:
