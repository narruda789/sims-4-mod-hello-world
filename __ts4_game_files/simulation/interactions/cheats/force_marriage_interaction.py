...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\interactions\cheats\force_marriage_interaction.py
# Compiled at: 2017-03-13 17:16:06
# Size of source mod 2**32: 6299 bytes
...
class ForceMarriageInteraction(ImmediateSuperInteraction):
    ...
    def _get_all_spouse_for_sim(cls, actor_sim_id):
        ...
        for sim_info in services.sim_info_manager().values():
            ...
            if actor_sim_info.relationship_tracker.has_bit(sim_info.id, RelationshipGlobalTuning.MARRIAGE_RELATIONSHIP_BIT) or sim_info.relationship_tracker.has_bit(actor_sim_info.id, RelationshipGlobalTuning.MARRIAGE_RELATIONSHIP_BIT):
                spouses.add(sim_info)
