...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\organizations\organization_handlers.py
# Compiled at: 2019-07-18 20:12:08
...
def get_organization_members(org_id, status_enum):
    ...
    for member_id in members_list:
        ...
        organization_member_data.append({'sim':sim_info.full_name, 
         'progress':progress_stat.get_value(), 
         'rank':progress_stat.rank_level})
...
def generate_organization_view():
    ...
    for org in services.snippet_manager().get_ordered_types(only_subclasses_of=Organization):
        organizations.append({'organization':str(org), 
         'active_members':get_organization_members(org.guid64, OrganizationStatusEnum.ACTIVE), 
         'inactive_members':get_organization_members(org.guid64, OrganizationStatusEnum.INACTIVE)})
