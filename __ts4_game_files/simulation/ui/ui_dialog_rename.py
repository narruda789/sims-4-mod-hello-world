...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\ui\ui_dialog_rename.py
# Compiled at: 2017-09-23 06:02:20
...
class RenameDialogElement(elements.ParentElement):
    ...
    def _run(self, timeline):
        ...
        elif isinstance(self._offspring_data, PregnancyOffspringData):
        ...
        self._dialog.show_dialog(on_response=(self._on_response), additional_tokens=additional_tokens,
          trait_overrides_for_baby=trait_overrides_for_baby,
          gender_overrides_for_baby=gender_overrides_for_baby)
