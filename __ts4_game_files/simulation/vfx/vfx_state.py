...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\vfx\vfx_state.py
# Compiled at: 2019-05-24 13:26:30
    ...
    def start(self):
        ...
        for state_owning_vfx in states_owning_vfx:
            ...
            if vfx_distributable is not None:
                ...
                if client_connected or self._pending_primitives is None:
