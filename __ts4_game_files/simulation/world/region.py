...
# Size of source mod 2**32: 19660 bytes
...
class Region(HasTunableReference, ComponentContainer, HasStatisticComponent, WeatherTuningMixin, SeasonalParametersMixin, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.REGION)):
