...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\world\spawn_point_component.py
# Compiled at: 2018-01-16 17:01:55
# Size of source mod 2**32: 4935 bytes
...
class SpawnPointComponent(Component, HasTunableFactory, AutoFactoryInit, component_name=SPAWN_POINT_COMPONENT, allow_dynamic=True):
    ...
    def _add_spawn_point(self, point):
        spawn_point = DynamicObjectSpawnPoint((self.owner), (point.spawner_tags), bone_name=(point.bone_name),
