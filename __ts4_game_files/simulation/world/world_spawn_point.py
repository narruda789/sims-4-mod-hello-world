...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\world\world_spawn_point.py
# Compiled at: 2018-11-09 16:29:53
# Size of source mod 2**32: 8555 bytes
from _math import Vector3Immutable, Vector3
import random
from world.spawn_point import SpawnPoint
import build_buy, interactions.constraints, routing, services, sims4.log, sims4.math, sims4.random
...
class WorldSpawnPoint(SpawnPoint):
    ...
    def _get_slot_pos(self, index):
        if not (index is None or 0) <= index <= WorldSpawnPoint.SPAWN_POINT_SLOTS - 1:
