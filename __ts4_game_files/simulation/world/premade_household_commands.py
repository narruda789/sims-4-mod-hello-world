...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\world\premade_household_commands.py
# Compiled at: 2019-08-22 14:27:44
# Size of source mod 2**32: 5323 bytes
...
import persistence_module, services, sims4.commands
        ...
        try:
            ...
            for sim_info in household.sim_info_gen():
                ...
                if tracker.has_any_occult_or_part_occult_trait():
                    ...
                    if sim_template is not None and sim_template.occult is not None:
