...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\world\dynamic_spawn_point.py
# Compiled at: 2019-07-11 14:01:21
# Size of source mod 2**32: 11026 bytes
...
import element_utils, interactions.constraints, placement, routing, services, sims4.log, tag
...
class DynamicInteractionSpawnPoint(SpawnPoint):
    ...
    def _get_pos(self):
        ...
        if participant is not None:
            ...
            starting_location = placement.create_starting_location(position=(participant.position), orientation=(participant.orientation),
            ...
            fgl_context = placement.FindGoodLocationContext(starting_location, max_distance=(FGLTuning.MAX_FGL_DISTANCE),
              additional_avoid_sim_radius=(routing.get_default_agent_radius()),
              max_steps=10,
              position_increment_info=pos_increment_info,
              offset_distance=(self._distance_to_participant),
              scoring_functions=(
             scoring_function,),
