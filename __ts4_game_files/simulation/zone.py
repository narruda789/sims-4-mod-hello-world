...
# Size of source mod 2**32: 97320 bytes
...
class Zone:
    ...
    def start_services(self, gameplay_zone_data, save_slot_data):
        ...
        service_list = [
         ...
         PostureGraphService(),
         ArbAccumulatorService(None, None),
         AutonomyService(),
         SimSpawnerService(),
         EnsembleService(),
 ...
 L.1856        86  LOAD_FAST                'travel_group'
               88  LOAD_CONST               None
               90  COMPARE_OP               is
               92  POP_JUMP_IF_TRUE    118  'to 118'

 L.1857        94  LOAD_GLOBAL              protocol_buffer_utils
 ...
 L.1858       106  LOAD_FAST                'gameplay_zone_data'
 ...
 L.1870       148  LOAD_GLOBAL              protocol_buffer_utils
 ...
 L.1871       160  LOAD_FAST                'gameplay_zone_data'
...
Parse error at or near `COME_FROM' instruction at offset 136_0
 ...
 L.1923        38  LOAD_CONST               False
               40  RETURN_VALUE     
             42_0  COME_FROM            36  '36'

 L.1924        42  LOAD_CONST               True
               44  RETURN_VALUE     
               -1  RETURN_LAST      
