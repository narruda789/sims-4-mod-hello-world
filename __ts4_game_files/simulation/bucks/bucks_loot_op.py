...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\bucks\bucks_loot_op.py
# Compiled at: 2020-05-15 22:07:46
# Size of source mod 2**32: 13464 bytes
import build_buy
...
class _PerkProgressStrategy(HasTunableSingletonFactory, AutoFactoryInit):
    FACTORY_TUNABLES = {'progress': Tunable(description='\n            This is the amount of progress to give towards awarding the perk',
                   tunable_type=float,
                   default=0)}
...
class AwardPerkLoot(BaseLootOperation):
    FACTORY_TUNABLES = {'description':'\n            This loot will give the specified perk to the sim.\n            ', 
     ...
     'award_strategy':TunableVariant(unlock=_UnlockPerkStrategy.TunableFactory(),
       progress=_PerkProgressStrategy.TunableFactory(),
       default='unlock'), 
     'notification_on_successful_unlock':OptionalTunable(description='\n            If enabled, a notification that displays when the perk is\n            successfully awarded.\n            ',
