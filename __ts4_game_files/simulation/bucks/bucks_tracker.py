...
# Size of source mod 2**32: 34728 bytes
...
class BucksTrackerBase:
    ...
    def _award_traits(self, perk):
        if not perk.traits_to_award:
            return
        for sim_info in self._owner_sim_info_gen():
            for trait in perk.traits_to_award:
