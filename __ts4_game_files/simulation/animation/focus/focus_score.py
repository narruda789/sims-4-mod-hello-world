...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\animation\focus\focus_score.py
# Compiled at: 2019-01-16 21:58:53
...
class _FocusScoreSpecies(HasTunableSingletonFactory, AutoFactoryInit):
    FACTORY_TUNABLES = {'scores': TunableMapping(description='\n            A mapping of species to the focus score specific to that\n            species.\n            ',
                 ...
                 invalid_enums=(
                Species.INVALID,)),
                 value_type=(_FocusScoreGlobal.TunableFactory()))}
...
class TunableFocusScoreVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, description='\n            Define how focus score is determined for this object.\n            ', 
         globally=_FocusScoreGlobal.TunableFactory(), 
         species_specific=_FocusScoreSpecies.TunableFactory(), 
         default='globally', **kwargs)