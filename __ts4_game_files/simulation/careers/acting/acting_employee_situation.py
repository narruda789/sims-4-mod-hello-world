...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\careers\acting\acting_employee_situation.py
# Compiled at: 2018-10-24 17:31:39
...
class _ActingEmployeePrePerformanceState(CommonInteractionCompletedSituationState):
    ...
    def _on_interaction_of_interest_complete(self, resolver=None, **kwargs):
        if resolver:
            if resolver.interaction.has_been_reset:
                return
...
class ActingEmployeeSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (SituationStateData(1, _ActingEmployeePrePerformanceState, factory=(cls._pre_performance_state)),
         SituationStateData(2, _ActingEmployeeGoToMarksState, factory=(cls._go_to_marks_state)),
         SituationStateData(3, _ActingEmployeePerformanceState, factory=(cls._performance_state)),
         SituationStateData(4, _ActingEmployeePostPerformanceState, factory=(cls._post_performance_state)))
