...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\careers\career_scheduler.py
# Compiled at: 2019-02-26 19:17:02
...
class TunableCareerScheduleVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, backwards_compatible=CareerScheduleBackwardsCompatible.TunableFactory(), 
         fixed=CareerScheduleFixed.TunableFactory(), 
         service_npc=CareerScheduleFromServiceNpc.TunableFactory(), 
         shifts=CareerScheduleShifts.TunableFactory(), 
         shifts_player=CareerScheduleShiftsPlayer.TunableFactory(), 
         no_schedule=CareerScheduleNoSchedule.TunableFactory(), 
         default='backwards_compatible', **kwargs)